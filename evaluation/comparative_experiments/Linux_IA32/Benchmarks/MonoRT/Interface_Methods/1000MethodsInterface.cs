...
namespace TimingTest
{
    ...
    class Timing1000MethodsInterface : ITiming1000MethodsInterface
	{
		...
		static int Main (string[] args)
		{
			...
			#endregion
			/*
			Timing1000MethodsInterface t1000mi = new Timing1000MethodsInterface();
			Type t = t1000mi.GetType();
			if (t != null) 
			{
			...
			Timing1000MethodsInterfaceSecond t1000mis = new Timing1000MethodsInterfaceSecond();
			t = t1000mis.GetType();
			if (t != null) 
			{
				Console.WriteLine("Type2 gefunden.");
				Marshal.PrelinkAll(t);
			}
			*/
