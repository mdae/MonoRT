...
{
	class Timing1000StaticMethods
	{

		[DllImport("libtimer")]
		// read the CPU's time stamp counter
		static extern long getticks ();

		[DllImport("libtimer")]
		// read the CPU's frequency
		static extern long getcycles ();

		[DllImport("libtimer")]
		// clean the CPU and the filesystem cache
		static extern int cleancache ();
		...
		static int Main (string[] args)
		{
			...
			strtIndx = args[1].IndexOf("::");
			//
			//  Bestimmung des Sekunden-Anteils des per Kommandozeile uebergebenen Arguments
			//
			seconds = args[1].Substring(0, strtIndx);
			//
			//  Bestimmung der Nanosekunden-Anteils des per Kommandozeile uebergebenen Arguments
			//
			nanoseconds = args[1].Substring(strtIndx + "::".Length);
			//Console.WriteLine("seconds: " + seconds);
			//Console.WriteLine("nanoseconds: " + nanoseconds);
			//
			//  Das per Kommandozeile uebergebene Argument zaehlt die Zeit
			//  seit dem 1.1.1970 0 Uhr
			//
			origin = new DateTime(1970,1,1,0,0,0);
			since = double.Parse(seconds);
			sincens = double.Parse(nanoseconds);
			...
			//
			// Berechnung der Sekunden, die seit dem 1.1.1970 vergangen sind
			//
			since = since + sincens;
			//Console.WriteLine("since: " + since.ToString());
			//
			//  Berechnung eines Date-Time-Objekts, das die per Kommandozeile
			//  uebergeben Startzeit der Vm repraesentiert
			//
			launchTime = origin.AddSeconds(since);
			//Console.WriteLine("sincens: " + sincens.ToString());
			//DateTime launchTime = System.DateTime.FromFileTimeUtc(long.Parse (args[1]));
			//Console.WriteLine("launchTime: " + launchTime);
			//Console.WriteLine("launchTime.Ticks: " + launchTime.Ticks);
			//Console.WriteLine("mainEntryTime: " + mainEntryTime);
			//Console.WriteLine("mainEntryTime.Ticks: " + mainEntryTime.Ticks);
			//Console.WriteLine("Differenz (Ticks): " + (mainEntryTime.Ticks - launchTime.Ticks));
			Console.WriteLine("Startuptime (ms): " + ((mainEntryTime.Ticks - launchTime.Ticks) / TicksPerMiliSecond));
			
			StreamWriter outfile = File.AppendText (args [0]);
			outfile.WriteLine("startuptime:\t" + ((mainEntryTime.Ticks - launchTime.Ticks) / TicksPerMiliSecond));
			#endregion
			
			Timing1000StaticMethods t1000mp = new Timing1000StaticMethods();
/*			Type t = t1000mp.GetType();
			if (t != null) 
			{
				Console.WriteLine("Type gefunden.");
				Marshal.PrelinkAll(t);
			}
*/			
			long tsc_before, tsc_after, overhead, min, cycles_per_second, time1, time2, time3, time4;
			tsc_before = tsc_after = overhead = min = cycles_per_second = time1 = time2 = time3 = time4 = 0;
			...
			Console.WriteLine ("Final Overhead: " + min + " CPU cycles");
			...
			for (cnt = 0; cnt < 6; cnt++) {
				...
				if (cnt < 3) {
					...
					var523 = method0 (var961, var5);
					var656 = method1 (var313, var614);
					var375 = method2 (var612, var44);
					var458 = method3 (var711, var861);
					var578 = method4 (var565, var904);
					var351 = method5 (var491, var952);
					var321 = method6 (var286, var902);
					var107 = method7 (var770, var548);
					var422 = method8 (var409, var563);
					var849 = method9 (var61, var72);
					var280 = method10 (var522, var186);
					var623 = method11 (var678, var879);
					var743 = method12 (var569, var744);
					var669 = method13 (var510, var148);
					var759 = method14 (var887, var155);
					var777 = method15 (var8, var125);
					var529 = method16 (var939, var454);
					var908 = method17 (var512, var461);
					var692 = method18 (var1, var774);
					var382 = method19 (var978, var433);
					var871 = method20 (var805, var867);
					var374 = method21 (var948, var563);
					var101 = method22 (var691, var409);
					var127 = method23 (var342, var365);
					var422 = method24 (var381, var832);
					var993 = method25 (var594, var309);
					var855 = method26 (var421, var634);
					var181 = method27 (var871, var627);
					var200 = method28 (var475, var654);
					var811 = method29 (var674, var114);
					var778 = method30 (var51, var159);
					var617 = method31 (var327, var144);
					var725 = method32 (var378, var54);
					var161 = method33 (var182, var699);
					var269 = method34 (var108, var304);
					var273 = method35 (var37, var884);
					var260 = method36 (var216, var346);
					var963 = method37 (var707, var863);
					var655 = method38 (var819, var645);
					var249 = method39 (var47, var804);
					var837 = method40 (var723, var636);
					var248 = method41 (var944, var643);
					var96 = method42 (var314, var76);
					var559 = method43 (var956, var709);
					var49 = method44 (var639, var74);
					var670 = method45 (var473, var8);
					var972 = method46 (var381, var829);
					var404 = method47 (var763, var870);
					var277 = method48 (var55, var415);
					var911 = method49 (var673, var683);
					var48 = method50 (var411, var301);
					var495 = method51 (var205, var472);
					var650 = method52 (var630, var33);
					var633 = method53 (var799, var28);
					var912 = method54 (var879, var386);
					var942 = method55 (var199, var836);
					var585 = method56 (var600, var404);
					var734 = method57 (var576, var364);
					var755 = method58 (var425, var421);
					var140 = method59 (var42, var471);
					var993 = method60 (var465, var280);
					var442 = method61 (var759, var927);
					var797 = method62 (var169, var252);
					var132 = method63 (var471, var636);
					var422 = method64 (var372, var976);
					var95 = method65 (var827, var399);
					var115 = method66 (var851, var633);
					var274 = method67 (var868, var201);
					var690 = method68 (var582, var131);
					var858 = method69 (var736, var277);
					var675 = method70 (var480, var377);
					var901 = method71 (var162, var605);
					var540 = method72 (var903, var291);
					var114 = method73 (var800, var721);
					var734 = method74 (var966, var130);
					var865 = method75 (var375, var674);
					var173 = method76 (var294, var562);
					var404 = method77 (var765, var795);
					var513 = method78 (var87, var378);
					var279 = method79 (var597, var322);
					var256 = method80 (var266, var960);
					var18 = method81 (var670, var915);
					var688 = method82 (var405, var845);
					var229 = method83 (var452, var725);
					var941 = method84 (var556, var71);
					var869 = method85 (var102, var405);
					var176 = method86 (var494, var752);
					var578 = method87 (var138, var955);
					var418 = method88 (var213, var417);
					var883 = method89 (var491, var247);
					var917 = method90 (var134, var57);
					var61 = method91 (var661, var74);
					var780 = method92 (var177, var895);
					var261 = method93 (var762, var969);
					var497 = method94 (var678, var542);
					var983 = method95 (var266, var810);
					var376 = method96 (var299, var670);
					var495 = method97 (var788, var350);
					var404 = method98 (var122, var208);
					var898 = method99 (var356, var596);
					var135 = method100 (var510, var583);
					var466 = method101 (var482, var228);
					var262 = method102 (var14, var87);
					var602 = method103 (var292, var28);
					var876 = method104 (var823, var256);
					var790 = method105 (var788, var550);
					var296 = method106 (var4, var518);
					var526 = method107 (var895, var112);
					var406 = method108 (var623, var474);
					var594 = method109 (var178, var846);
					var517 = method110 (var163, var808);
					var658 = method111 (var470, var941);
					var620 = method112 (var855, var285);
					var193 = method113 (var477, var259);
					var80 = method114 (var295, var152);
					var969 = method115 (var892, var238);
					var998 = method116 (var498, var734);
					var303 = method117 (var177, var749);
					var617 = method118 (var347, var702);
					var925 = method119 (var996, var541);
					var607 = method120 (var407, var728);
					var893 = method121 (var125, var32);
					var948 = method122 (var581, var671);
					var287 = method123 (var898, var550);
					var551 = method124 (var798, var270);
					var214 = method125 (var348, var145);
					var494 = method126 (var58, var921);
					var548 = method127 (var598, var637);
					var238 = method128 (var109, var434);
					var914 = method129 (var533, var437);
					var992 = method130 (var38, var184);
					var997 = method131 (var294, var927);
					var708 = method132 (var281, var24);
					var938 = method133 (var620, var746);
					var743 = method134 (var940, var576);
					var185 = method135 (var705, var540);
					var510 = method136 (var508, var913);
					var788 = method137 (var391, var559);
					var548 = method138 (var568, var223);
					var731 = method139 (var599, var197);
					var324 = method140 (var666, var556);
					var732 = method141 (var667, var151);
					var806 = method142 (var611, var221);
					var84 = method143 (var508, var808);
					var634 = method144 (var985, var144);
					var133 = method145 (var156, var39);
					var88 = method146 (var669, var885);
					var702 = method147 (var315, var335);
					var113 = method148 (var326, var481);
					var451 = method149 (var330, var142);
					var120 = method150 (var96, var60);
					var940 = method151 (var429, var811);
					var111 = method152 (var757, var795);
					var443 = method153 (var28, var666);
					var451 = method154 (var840, var622);
					var210 = method155 (var472, var56);
					var446 = method156 (var222, var86);
					var772 = method157 (var401, var456);
					var76 = method158 (var227, var606);
					var616 = method159 (var303, var855);
					var40 = method160 (var48, var816);
					var778 = method161 (var55, var841);
					var357 = method162 (var793, var363);
					var934 = method163 (var660, var100);
					var592 = method164 (var866, var583);
					var113 = method165 (var301, var859);
					var258 = method166 (var885, var719);
					var865 = method167 (var148, var474);
					var102 = method168 (var72, var280);
					var281 = method169 (var885, var587);
					var454 = method170 (var317, var394);
					var861 = method171 (var782, var928);
					var73 = method172 (var584, var257);
					var508 = method173 (var908, var613);
					var797 = method174 (var560, var502);
					var221 = method175 (var623, var926);
					var353 = method176 (var4, var946);
					var324 = method177 (var730, var715);
					var400 = method178 (var722, var654);
					var955 = method179 (var995, var127);
					var768 = method180 (var772, var536);
					var854 = method181 (var25, var47);
					var303 = method182 (var32, var364);
					var361 = method183 (var489, var375);
					var505 = method184 (var254, var939);
					var395 = method185 (var135, var433);
					var74 = method186 (var379, var417);
					var325 = method187 (var285, var758);
					var819 = method188 (var682, var781);
					var539 = method189 (var835, var735);
					var624 = method190 (var41, var220);
					var896 = method191 (var19, var533);
					var108 = method192 (var543, var621);
					var106 = method193 (var85, var190);
					var852 = method194 (var973, var586);
					var620 = method195 (var38, var971);
					var895 = method196 (var718, var941);
					var114 = method197 (var119, var260);
					var502 = method198 (var726, var551);
					var639 = method199 (var835, var492);
					var938 = method200 (var760, var410);
					var257 = method201 (var276, var298);
					var523 = method202 (var531, var667);
					var318 = method203 (var356, var163);
					var537 = method204 (var355, var438);
					var303 = method205 (var206, var25);
					var256 = method206 (var93, var130);
					var141 = method207 (var704, var343);
					var796 = method208 (var863, var630);
					var963 = method209 (var619, var720);
					var10 = method210 (var576, var875);
					var303 = method211 (var749, var922);
					var653 = method212 (var496, var535);
					var282 = method213 (var414, var13);
					var715 = method214 (var802, var587);
					var799 = method215 (var409, var776);
					var464 = method216 (var638, var95);
					var588 = method217 (var20, var115);
					var482 = method218 (var362, var884);
					var107 = method219 (var507, var354);
					var645 = method220 (var26, var996);
					var384 = method221 (var903, var343);
					var447 = method222 (var735, var768);
					var638 = method223 (var893, var429);
					var561 = method224 (var617, var997);
					var542 = method225 (var121, var589);
					var860 = method226 (var434, var979);
					var523 = method227 (var455, var265);
					var74 = method228 (var983, var580);
					var491 = method229 (var399, var406);
					var474 = method230 (var918, var727);
					var896 = method231 (var388, var985);
					var452 = method232 (var98, var805);
					var44 = method233 (var678, var820);
					var915 = method234 (var29, var659);
					var572 = method235 (var132, var754);
					var40 = method236 (var499, var782);
					var393 = method237 (var707, var101);
					var880 = method238 (var727, var298);
					var100 = method239 (var995, var918);
					var891 = method240 (var349, var930);
					var723 = method241 (var960, var73);
					var513 = method242 (var531, var958);
					var425 = method243 (var409, var366);
					var548 = method244 (var361, var651);
					var585 = method245 (var815, var354);
					var385 = method246 (var347, var684);
					var479 = method247 (var495, var481);
					var514 = method248 (var124, var988);
					var4 = method249 (var935, var315);
					var471 = method250 (var921, var140);
					var380 = method251 (var635, var311);
					var271 = method252 (var554, var378);
					var74 = method253 (var756, var778);
					var368 = method254 (var693, var814);
					var302 = method255 (var897, var226);
					var586 = method256 (var755, var739);
					var294 = method257 (var164, var679);
					var447 = method258 (var970, var209);
					var550 = method259 (var87, var649);
					var801 = method260 (var959, var153);
					var883 = method261 (var668, var630);
					var997 = method262 (var855, var547);
					var349 = method263 (var687, var589);
					var767 = method264 (var629, var608);
					var390 = method265 (var315, var815);
					var33 = method266 (var544, var914);
					var438 = method267 (var916, var286);
					var514 = method268 (var511, var768);
					var256 = method269 (var711, var4);
					var313 = method270 (var416, var6);
					var28 = method271 (var386, var167);
					var11 = method272 (var739, var85);
					var424 = method273 (var987, var81);
					var192 = method274 (var41, var840);
					var300 = method275 (var377, var878);
					var165 = method276 (var936, var202);
					var953 = method277 (var838, var83);
					var335 = method278 (var384, var952);
					var124 = method279 (var497, var501);
					var619 = method280 (var258, var770);
					var122 = method281 (var362, var605);
					var396 = method282 (var725, var789);
					var307 = method283 (var12, var437);
					var650 = method284 (var97, var342);
					var961 = method285 (var599, var833);
					var950 = method286 (var129, var558);
					var643 = method287 (var758, var210);
					var385 = method288 (var54, var646);
					var884 = method289 (var666, var780);
					var770 = method290 (var285, var949);
					var777 = method291 (var411, var550);
					var431 = method292 (var94, var699);
					var879 = method293 (var701, var544);
					var927 = method294 (var36, var377);
					var558 = method295 (var194, var628);
					var698 = method296 (var280, var738);
					var68 = method297 (var458, var716);
					var730 = method298 (var333, var308);
					var992 = method299 (var710, var812);
					var173 = method300 (var302, var26);
					var909 = method301 (var606, var467);
					var509 = method302 (var613, var720);
					var784 = method303 (var767, var971);
					var135 = method304 (var669, var391);
					var489 = method305 (var185, var42);
					var479 = method306 (var51, var745);
					var654 = method307 (var173, var854);
					var607 = method308 (var467, var259);
					var40 = method309 (var171, var944);
					var40 = method310 (var818, var374);
					var915 = method311 (var111, var729);
					var409 = method312 (var257, var645);
					var887 = method313 (var372, var151);
					var148 = method314 (var646, var534);
					var83 = method315 (var894, var603);
					var109 = method316 (var263, var74);
					var268 = method317 (var820, var766);
					var771 = method318 (var355, var928);
					var111 = method319 (var798, var877);
					var58 = method320 (var251, var968);
					var832 = method321 (var411, var615);
					var823 = method322 (var488, var134);
					var307 = method323 (var594, var581);
					var933 = method324 (var216, var976);
					var477 = method325 (var833, var407);
					var82 = method326 (var251, var539);
					var148 = method327 (var241, var294);
					var885 = method328 (var788, var849);
					var542 = method329 (var503, var496);
					var906 = method330 (var921, var122);
					var338 = method331 (var292, var791);
					var218 = method332 (var932, var670);
					var57 = method333 (var250, var487);
					var521 = method334 (var858, var723);
					var925 = method335 (var26, var526);
					var880 = method336 (var982, var505);
					var386 = method337 (var607, var301);
					var970 = method338 (var136, var129);
					var630 = method339 (var539, var619);
					var396 = method340 (var890, var817);
					var76 = method341 (var56, var107);
					var60 = method342 (var75, var492);
					var51 = method343 (var450, var306);
					var526 = method344 (var99, var745);
					var153 = method345 (var541, var940);
					var323 = method346 (var748, var659);
					var219 = method347 (var2, var883);
					var99 = method348 (var15, var103);
					var45 = method349 (var281, var185);
					var731 = method350 (var143, var439);
					var619 = method351 (var607, var944);
					var961 = method352 (var421, var112);
					var569 = method353 (var384, var86);
					var203 = method354 (var132, var323);
					var285 = method355 (var383, var723);
					var202 = method356 (var955, var33);
					var83 = method357 (var348, var353);
					var888 = method358 (var253, var451);
					var198 = method359 (var469, var112);
					var145 = method360 (var638, var962);
					var922 = method361 (var666, var363);
					var103 = method362 (var394, var776);
					var459 = method363 (var770, var817);
					var738 = method364 (var367, var715);
					var576 = method365 (var871, var649);
					var994 = method366 (var846, var563);
					var904 = method367 (var576, var168);
					var40 = method368 (var92, var180);
					var516 = method369 (var952, var243);
					var840 = method370 (var567, var645);
					var652 = method371 (var799, var566);
					var348 = method372 (var835, var416);
					var746 = method373 (var414, var733);
					var728 = method374 (var355, var391);
					var128 = method375 (var506, var179);
					var313 = method376 (var796, var72);
					var934 = method377 (var246, var225);
					var271 = method378 (var578, var993);
					var310 = method379 (var123, var99);
					var15 = method380 (var267, var977);
					var29 = method381 (var45, var36);
					var89 = method382 (var382, var975);
					var586 = method383 (var70, var691);
					var336 = method384 (var198, var774);
					var629 = method385 (var658, var350);
					var897 = method386 (var461, var98);
					var870 = method387 (var393, var852);
					var228 = method388 (var572, var589);
					var615 = method389 (var607, var762);
					var477 = method390 (var965, var859);
					var829 = method391 (var676, var722);
					var397 = method392 (var530, var581);
					var762 = method393 (var470, var155);
					var282 = method394 (var851, var697);
					var201 = method395 (var541, var393);
					var997 = method396 (var699, var988);
					var378 = method397 (var703, var360);
					var622 = method398 (var50, var407);
					var147 = method399 (var352, var322);
					var638 = method400 (var559, var801);
					var212 = method401 (var116, var914);
					var408 = method402 (var484, var500);
					var573 = method403 (var87, var264);
					var353 = method404 (var197, var473);
					var720 = method405 (var167, var32);
					var229 = method406 (var177, var164);
					var441 = method407 (var262, var284);
					var123 = method408 (var917, var163);
					var646 = method409 (var713, var762);
					var314 = method410 (var913, var29);
					var8 = method411 (var675, var205);
					var802 = method412 (var84, var378);
					var977 = method413 (var33, var509);
					var164 = method414 (var819, var534);
					var546 = method415 (var115, var418);
					var236 = method416 (var704, var886);
					var760 = method417 (var434, var590);
					var8 = method418 (var725, var530);
					var793 = method419 (var537, var910);
					var111 = method420 (var324, var106);
					var523 = method421 (var539, var577);
					var100 = method422 (var533, var663);
					var926 = method423 (var604, var748);
					var795 = method424 (var524, var291);
					var404 = method425 (var7, var671);
					var276 = method426 (var397, var387);
					var369 = method427 (var109, var802);
					var650 = method428 (var989, var807);
					var505 = method429 (var468, var97);
					var105 = method430 (var269, var420);
					var452 = method431 (var373, var285);
					var714 = method432 (var639, var528);
					var129 = method433 (var539, var444);
					var142 = method434 (var839, var317);
					var516 = method435 (var651, var632);
					var939 = method436 (var18, var918);
					var24 = method437 (var324, var439);
					var805 = method438 (var842, var903);
					var653 = method439 (var150, var253);
					var863 = method440 (var460, var4);
					var533 = method441 (var386, var160);
					var606 = method442 (var956, var207);
					var774 = method443 (var752, var374);
					var732 = method444 (var257, var479);
					var363 = method445 (var45, var670);
					var996 = method446 (var808, var86);
					var153 = method447 (var355, var215);
					var233 = method448 (var644, var265);
					var886 = method449 (var66, var212);
					var678 = method450 (var757, var431);
					var754 = method451 (var377, var165);
					var712 = method452 (var884, var359);
					var953 = method453 (var471, var981);
					var635 = method454 (var131, var931);
					var765 = method455 (var668, var109);
					var205 = method456 (var160, var577);
					var16 = method457 (var587, var937);
					var575 = method458 (var106, var29);
					var249 = method459 (var156, var220);
					var448 = method460 (var722, var596);
					var254 = method461 (var302, var771);
					var738 = method462 (var600, var326);
					var713 = method463 (var695, var935);
					var464 = method464 (var835, var231);
					var69 = method465 (var565, var418);
					var639 = method466 (var127, var615);
					var15 = method467 (var729, var845);
					var764 = method468 (var956, var161);
					var177 = method469 (var452, var605);
					var427 = method470 (var111, var558);
					var646 = method471 (var257, var536);
					var516 = method472 (var800, var899);
					var861 = method473 (var199, var249);
					var470 = method474 (var78, var545);
					var561 = method475 (var286, var742);
					var172 = method476 (var618, var944);
					var852 = method477 (var797, var551);
					var793 = method478 (var337, var163);
					var950 = method479 (var996, var765);
					var254 = method480 (var938, var701);
					var464 = method481 (var514, var445);
					var465 = method482 (var386, var289);
					var669 = method483 (var783, var823);
					var245 = method484 (var20, var183);
					var762 = method485 (var217, var178);
					var51 = method486 (var427, var792);
					var211 = method487 (var180, var686);
					var350 = method488 (var488, var409);
					var93 = method489 (var131, var812);
					var71 = method490 (var130, var510);
					var229 = method491 (var78, var375);
					var3 = method492 (var449, var895);
					var782 = method493 (var343, var108);
					var690 = method494 (var744, var826);
					var733 = method495 (var671, var111);
					var200 = method496 (var304, var927);
					var70 = method497 (var818, var184);
					var694 = method498 (var123, var427);
					var471 = method499 (var385, var138);
					var441 = method500 (var15, var490);
					var506 = method501 (var326, var675);
					var133 = method502 (var501, var194);
					var449 = method503 (var90, var106);
					var977 = method504 (var746, var500);
					var722 = method505 (var392, var995);
					var991 = method506 (var226, var60);
					var937 = method507 (var707, var993);
					var370 = method508 (var55, var639);
					var3 = method509 (var903, var403);
					var242 = method510 (var502, var255);
					var445 = method511 (var692, var237);
					var130 = method512 (var943, var244);
					var104 = method513 (var340, var676);
					var119 = method514 (var974, var243);
					var989 = method515 (var362, var825);
					var814 = method516 (var639, var484);
					var424 = method517 (var568, var982);
					var896 = method518 (var939, var760);
					var45 = method519 (var814, var89);
					var544 = method520 (var189, var256);
					var89 = method521 (var108, var414);
					var986 = method522 (var3, var502);
					var510 = method523 (var360, var567);
					var181 = method524 (var352, var742);
					var636 = method525 (var369, var725);
					var96 = method526 (var431, var295);
					var594 = method527 (var188, var814);
					var858 = method528 (var52, var246);
					var165 = method529 (var336, var277);
					var250 = method530 (var126, var440);
					var733 = method531 (var744, var773);
					var494 = method532 (var767, var231);
					var607 = method533 (var619, var636);
					var728 = method534 (var383, var343);
					var889 = method535 (var236, var754);
					var123 = method536 (var843, var692);
					var594 = method537 (var708, var537);
					var838 = method538 (var417, var748);
					var522 = method539 (var345, var335);
					var920 = method540 (var219, var772);
					var895 = method541 (var891, var723);
					var839 = method542 (var798, var8);
					var852 = method543 (var400, var615);
					var601 = method544 (var253, var738);
					var700 = method545 (var885, var650);
					var975 = method546 (var441, var303);
					var723 = method547 (var820, var1);
					var357 = method548 (var31, var354);
					var545 = method549 (var842, var20);
					var934 = method550 (var696, var758);
					var378 = method551 (var206, var4);
					var34 = method552 (var475, var644);
					var643 = method553 (var3, var585);
					var778 = method554 (var682, var539);
					var969 = method555 (var774, var707);
					var180 = method556 (var806, var62);
					var203 = method557 (var680, var324);
					var401 = method558 (var223, var460);
					var393 = method559 (var688, var887);
					var688 = method560 (var363, var153);
					var365 = method561 (var849, var815);
					var837 = method562 (var919, var713);
					var769 = method563 (var926, var178);
					var470 = method564 (var168, var378);
					var100 = method565 (var43, var495);
					var599 = method566 (var133, var571);
					var961 = method567 (var856, var955);
					var332 = method568 (var570, var542);
					var393 = method569 (var529, var391);
					var166 = method570 (var114, var762);
					var875 = method571 (var716, var825);
					var114 = method572 (var609, var303);
					var439 = method573 (var925, var278);
					var108 = method574 (var46, var235);
					var101 = method575 (var346, var724);
					var992 = method576 (var831, var681);
					var66 = method577 (var864, var296);
					var720 = method578 (var573, var601);
					var278 = method579 (var648, var23);
					var700 = method580 (var228, var616);
					var273 = method581 (var843, var647);
					var69 = method582 (var424, var933);
					var277 = method583 (var754, var318);
					var502 = method584 (var768, var451);
					var504 = method585 (var96, var560);
					var234 = method586 (var758, var968);
					var263 = method587 (var744, var506);
					var690 = method588 (var938, var498);
					var488 = method589 (var31, var69);
					var756 = method590 (var690, var675);
					var26 = method591 (var685, var607);
					var775 = method592 (var340, var594);
					var730 = method593 (var4, var786);
					var489 = method594 (var234, var862);
					var418 = method595 (var322, var357);
					var606 = method596 (var781, var75);
					var113 = method597 (var247, var579);
					var266 = method598 (var10, var552);
					var589 = method599 (var588, var236);
					var871 = method600 (var729, var829);
					var202 = method601 (var272, var967);
					var828 = method602 (var268, var905);
					var33 = method603 (var182, var739);
					var953 = method604 (var453, var683);
					var855 = method605 (var16, var164);
					var239 = method606 (var680, var386);
					var909 = method607 (var899, var794);
					var197 = method608 (var26, var861);
					var473 = method609 (var753, var717);
					var778 = method610 (var507, var434);
					var561 = method611 (var547, var265);
					var832 = method612 (var36, var551);
					var6 = method613 (var402, var157);
					var118 = method614 (var926, var395);
					var165 = method615 (var213, var452);
					var382 = method616 (var239, var149);
					var78 = method617 (var835, var871);
					var458 = method618 (var364, var294);
					var267 = method619 (var655, var7);
					var135 = method620 (var792, var717);
					var898 = method621 (var631, var25);
					var620 = method622 (var27, var57);
					var517 = method623 (var642, var563);
					var782 = method624 (var999, var530);
					var307 = method625 (var73, var28);
					var336 = method626 (var832, var732);
					var593 = method627 (var818, var746);
					var582 = method628 (var985, var789);
					var535 = method629 (var929, var522);
					var644 = method630 (var805, var978);
					var33 = method631 (var364, var838);
					var374 = method632 (var118, var395);
					var87 = method633 (var92, var184);
					var116 = method634 (var549, var507);
					var556 = method635 (var260, var89);
					var289 = method636 (var472, var575);
					var758 = method637 (var338, var132);
					var363 = method638 (var330, var813);
					var683 = method639 (var534, var792);
					var650 = method640 (var502, var632);
					var970 = method641 (var424, var457);
					var447 = method642 (var232, var491);
					var974 = method643 (var46, var983);
					var739 = method644 (var863, var257);
					var973 = method645 (var255, var685);
					var383 = method646 (var252, var172);
					var105 = method647 (var1, var137);
					var871 = method648 (var141, var172);
					var8 = method649 (var608, var906);
					var391 = method650 (var142, var626);
					var420 = method651 (var41, var108);
					var445 = method652 (var252, var292);
					var534 = method653 (var300, var575);
					var705 = method654 (var36, var300);
					var469 = method655 (var757, var200);
					var261 = method656 (var221, var157);
					var804 = method657 (var74, var627);
					var401 = method658 (var508, var875);
					var211 = method659 (var928, var316);
					var11 = method660 (var195, var940);
					var957 = method661 (var673, var470);
					var277 = method662 (var702, var563);
					var787 = method663 (var215, var54);
					var423 = method664 (var162, var95);
					var367 = method665 (var30, var373);
					var735 = method666 (var363, var266);
					var961 = method667 (var79, var292);
					var895 = method668 (var196, var202);
					var669 = method669 (var746, var570);
					var830 = method670 (var743, var688);
					var504 = method671 (var318, var246);
					var152 = method672 (var543, var941);
					var932 = method673 (var438, var383);
					var465 = method674 (var898, var954);
					var195 = method675 (var724, var782);
					var732 = method676 (var205, var306);
					var205 = method677 (var464, var358);
					var485 = method678 (var268, var506);
					var435 = method679 (var638, var427);
					var318 = method680 (var734, var760);
					var630 = method681 (var349, var832);
					var588 = method682 (var524, var207);
					var899 = method683 (var643, var248);
					var641 = method684 (var530, var57);
					var60 = method685 (var496, var721);
					var807 = method686 (var626, var690);
					var766 = method687 (var31, var319);
					var251 = method688 (var96, var982);
					var58 = method689 (var155, var486);
					var657 = method690 (var627, var336);
					var42 = method691 (var289, var190);
					var741 = method692 (var935, var841);
					var894 = method693 (var699, var3);
					var974 = method694 (var105, var515);
					var539 = method695 (var174, var145);
					var106 = method696 (var388, var285);
					var448 = method697 (var280, var151);
					var769 = method698 (var691, var397);
					var717 = method699 (var341, var159);
					var90 = method700 (var653, var683);
					var312 = method701 (var200, var639);
					var274 = method702 (var535, var15);
					var517 = method703 (var886, var351);
					var614 = method704 (var418, var341);
					var242 = method705 (var485, var879);
					var549 = method706 (var560, var698);
					var265 = method707 (var716, var995);
					var395 = method708 (var3, var943);
					var23 = method709 (var842, var649);
					var915 = method710 (var206, var920);
					var323 = method711 (var8, var347);
					var389 = method712 (var555, var764);
					var273 = method713 (var53, var294);
					var595 = method714 (var546, var690);
					var20 = method715 (var731, var284);
					var756 = method716 (var766, var747);
					var374 = method717 (var875, var691);
					var243 = method718 (var884, var733);
					var359 = method719 (var304, var852);
					var250 = method720 (var718, var770);
					var741 = method721 (var463, var591);
					var755 = method722 (var67, var728);
					var320 = method723 (var510, var201);
					var123 = method724 (var783, var813);
					var324 = method725 (var389, var24);
					var752 = method726 (var511, var269);
					var584 = method727 (var718, var989);
					var399 = method728 (var197, var435);
					var178 = method729 (var859, var416);
					var591 = method730 (var321, var827);
					var444 = method731 (var762, var852);
					var171 = method732 (var811, var732);
					var365 = method733 (var630, var706);
					var532 = method734 (var245, var496);
					var162 = method735 (var655, var885);
					var292 = method736 (var45, var449);
					var555 = method737 (var499, var887);
					var260 = method738 (var928, var891);
					var326 = method739 (var979, var611);
					var419 = method740 (var943, var335);
					var362 = method741 (var690, var803);
					var669 = method742 (var877, var287);
					var650 = method743 (var668, var504);
					var732 = method744 (var706, var61);
					var713 = method745 (var84, var830);
					var728 = method746 (var470, var306);
					var108 = method747 (var198, var248);
					var996 = method748 (var647, var986);
					var464 = method749 (var753, var958);
					var183 = method750 (var293, var524);
					var82 = method751 (var697, var126);
					var973 = method752 (var825, var183);
					var782 = method753 (var77, var824);
					var156 = method754 (var821, var739);
					var340 = method755 (var356, var251);
					var891 = method756 (var613, var942);
					var426 = method757 (var573, var20);
					var428 = method758 (var126, var419);
					var252 = method759 (var665, var564);
					var829 = method760 (var843, var694);
					var505 = method761 (var572, var843);
					var347 = method762 (var911, var967);
					var721 = method763 (var357, var833);
					var939 = method764 (var115, var527);
					var880 = method765 (var535, var178);
					var819 = method766 (var870, var228);
					var733 = method767 (var799, var189);
					var129 = method768 (var339, var598);
					var19 = method769 (var509, var853);
					var778 = method770 (var62, var858);
					var462 = method771 (var425, var244);
					var884 = method772 (var40, var293);
					var859 = method773 (var805, var178);
					var431 = method774 (var20, var384);
					var209 = method775 (var627, var383);
					var891 = method776 (var89, var527);
					var399 = method777 (var743, var811);
					var785 = method778 (var767, var985);
					var232 = method779 (var79, var328);
					var958 = method780 (var306, var617);
					var108 = method781 (var915, var178);
					var402 = method782 (var919, var731);
					var318 = method783 (var253, var152);
					var287 = method784 (var730, var342);
					var828 = method785 (var990, var987);
					var404 = method786 (var361, var353);
					var366 = method787 (var939, var180);
					var894 = method788 (var471, var445);
					var750 = method789 (var546, var246);
					var841 = method790 (var965, var309);
					var974 = method791 (var606, var653);
					var890 = method792 (var700, var677);
					var556 = method793 (var218, var639);
					var979 = method794 (var529, var735);
					var161 = method795 (var460, var562);
					var917 = method796 (var313, var322);
					var235 = method797 (var686, var833);
					var486 = method798 (var993, var997);
					var642 = method799 (var501, var262);
					var288 = method800 (var701, var241);
					var175 = method801 (var99, var613);
					var172 = method802 (var758, var995);
					var181 = method803 (var368, var428);
					var70 = method804 (var90, var39);
					var118 = method805 (var679, var106);
					var694 = method806 (var901, var474);
					var802 = method807 (var248, var283);
					var958 = method808 (var140, var724);
					var134 = method809 (var874, var992);
					var480 = method810 (var132, var704);
					var496 = method811 (var187, var790);
					var569 = method812 (var888, var489);
					var616 = method813 (var481, var354);
					var867 = method814 (var15, var839);
					var519 = method815 (var987, var403);
					var875 = method816 (var346, var268);
					var862 = method817 (var768, var509);
					var782 = method818 (var155, var996);
					var745 = method819 (var987, var309);
					var44 = method820 (var284, var268);
					var378 = method821 (var699, var14);
					var560 = method822 (var54, var251);
					var519 = method823 (var131, var276);
					var230 = method824 (var347, var632);
					var611 = method825 (var33, var738);
					var501 = method826 (var802, var143);
					var978 = method827 (var147, var565);
					var948 = method828 (var195, var863);
					var325 = method829 (var796, var173);
					var230 = method830 (var514, var637);
					var969 = method831 (var485, var205);
					var123 = method832 (var520, var383);
					var227 = method833 (var486, var248);
					var902 = method834 (var73, var203);
					var290 = method835 (var715, var202);
					var561 = method836 (var586, var291);
					var671 = method837 (var948, var813);
					var78 = method838 (var529, var647);
					var299 = method839 (var893, var494);
					var890 = method840 (var39, var671);
					var24 = method841 (var33, var882);
					var374 = method842 (var157, var144);
					var342 = method843 (var896, var831);
					var177 = method844 (var914, var510);
					var471 = method845 (var29, var333);
					var487 = method846 (var418, var548);
					var564 = method847 (var432, var302);
					var283 = method848 (var190, var843);
					var613 = method849 (var935, var603);
					var831 = method850 (var966, var375);
					var40 = method851 (var331, var654);
					var71 = method852 (var987, var562);
					var731 = method853 (var260, var381);
					var715 = method854 (var142, var37);
					var726 = method855 (var238, var646);
					var530 = method856 (var887, var686);
					var34 = method857 (var363, var289);
					var662 = method858 (var924, var664);
					var630 = method859 (var693, var379);
					var810 = method860 (var387, var595);
					var412 = method861 (var81, var514);
					var115 = method862 (var34, var877);
					var784 = method863 (var233, var383);
					var803 = method864 (var599, var731);
					var514 = method865 (var201, var142);
					var639 = method866 (var358, var526);
					var212 = method867 (var919, var556);
					var792 = method868 (var444, var370);
					var963 = method869 (var958, var816);
					var538 = method870 (var36, var110);
					var777 = method871 (var498, var876);
					var578 = method872 (var116, var410);
					var522 = method873 (var525, var95);
					var6 = method874 (var171, var360);
					var474 = method875 (var114, var806);
					var497 = method876 (var218, var553);
					var700 = method877 (var672, var876);
					var840 = method878 (var774, var276);
					var817 = method879 (var914, var205);
					var936 = method880 (var999, var623);
					var354 = method881 (var258, var137);
					var377 = method882 (var631, var238);
					var257 = method883 (var400, var394);
					var645 = method884 (var421, var805);
					var826 = method885 (var540, var43);
					var716 = method886 (var18, var167);
					var553 = method887 (var48, var753);
					var880 = method888 (var538, var412);
					var756 = method889 (var518, var360);
					var499 = method890 (var946, var877);
					var153 = method891 (var122, var130);
					var449 = method892 (var585, var366);
					var534 = method893 (var934, var70);
					var90 = method894 (var478, var51);
					var0 = method895 (var652, var918);
					var996 = method896 (var301, var361);
					var520 = method897 (var298, var554);
					var705 = method898 (var989, var122);
					var470 = method899 (var231, var128);
					var688 = method900 (var792, var265);
					var703 = method901 (var323, var329);
					var303 = method902 (var166, var369);
					var804 = method903 (var173, var621);
					var47 = method904 (var414, var657);
					var646 = method905 (var254, var494);
					var47 = method906 (var890, var416);
					var942 = method907 (var524, var390);
					var672 = method908 (var707, var680);
					var174 = method909 (var829, var792);
					var827 = method910 (var283, var215);
					var561 = method911 (var361, var312);
					var23 = method912 (var676, var821);
					var404 = method913 (var746, var157);
					var870 = method914 (var105, var885);
					var418 = method915 (var996, var908);
					var882 = method916 (var998, var309);
					var948 = method917 (var640, var438);
					var301 = method918 (var404, var576);
					var703 = method919 (var342, var10);
					var305 = method920 (var627, var345);
					var965 = method921 (var57, var15);
					var751 = method922 (var941, var529);
					var238 = method923 (var650, var346);
					var611 = method924 (var48, var581);
					var468 = method925 (var301, var85);
					var89 = method926 (var267, var130);
					var977 = method927 (var831, var819);
					var486 = method928 (var199, var937);
					var250 = method929 (var504, var345);
					var561 = method930 (var82, var146);
					var583 = method931 (var753, var400);
					var546 = method932 (var821, var524);
					var417 = method933 (var117, var910);
					var818 = method934 (var615, var868);
					var332 = method935 (var116, var821);
					var952 = method936 (var101, var467);
					var326 = method937 (var199, var997);
					var449 = method938 (var223, var480);
					var762 = method939 (var211, var657);
					var469 = method940 (var929, var416);
					var112 = method941 (var120, var739);
					var527 = method942 (var996, var180);
					var248 = method943 (var351, var480);
					var133 = method944 (var988, var799);
					var804 = method945 (var777, var834);
					var369 = method946 (var263, var718);
					var175 = method947 (var39, var846);
					var875 = method948 (var631, var666);
					var34 = method949 (var462, var13);
					var872 = method950 (var550, var640);
					var275 = method951 (var65, var637);
					var777 = method952 (var830, var815);
					var64 = method953 (var554, var282);
					var451 = method954 (var688, var382);
					var291 = method955 (var287, var353);
					var121 = method956 (var817, var557);
					var446 = method957 (var300, var197);
					var784 = method958 (var919, var288);
					var140 = method959 (var46, var483);
					var962 = method960 (var697, var180);
					var116 = method961 (var694, var69);
					var28 = method962 (var444, var605);
					var507 = method963 (var517, var424);
					var712 = method964 (var551, var706);
					var272 = method965 (var875, var841);
					var61 = method966 (var956, var342);
					var525 = method967 (var987, var978);
					var51 = method968 (var175, var369);
					var524 = method969 (var581, var996);
					var608 = method970 (var332, var224);
					var307 = method971 (var546, var130);
					var570 = method972 (var899, var982);
					var109 = method973 (var416, var445);
					var291 = method974 (var165, var475);
					var31 = method975 (var458, var321);
					var146 = method976 (var609, var549);
					var764 = method977 (var558, var50);
					var875 = method978 (var629, var472);
					var873 = method979 (var569, var564);
					var499 = method980 (var129, var461);
					var495 = method981 (var91, var71);
					var132 = method982 (var546, var76);
					var674 = method983 (var814, var553);
					var695 = method984 (var452, var406);
					var578 = method985 (var966, var937);
					var103 = method986 (var421, var702);
					var496 = method987 (var954, var17);
					var497 = method988 (var479, var871);
					var729 = method989 (var216, var475);
					var997 = method990 (var23, var822);
					var307 = method991 (var295, var862);
					var750 = method992 (var839, var759);
					var896 = method993 (var64, var521);
					var218 = method994 (var724, var906);
					var53 = method995 (var809, var541);
					var553 = method996 (var395, var758);
					var742 = method997 (var656, var94);
					var566 = method998 (var475, var306);
					var154 = method999 (var200, var228);
				}
				tsc_after = getticks ();
				if (cnt == 3)
			...
			#endregion
			if (File.Exists ("frequency.txt")) {
				StreamReader frequency = File.OpenText ("frequency.txt");
				cycles_per_second = Int64.Parse (frequency.ReadLine ());
				frequency.Close ();
			} else {
				cycles_per_second = getcycles ();
				TextWriter frequency = new StreamWriter ("frequency.txt");
				frequency.WriteLine (cycles_per_second.ToString ());
				frequency.Close ();
			}

			Console.WriteLine ("Frequency: " + cycles_per_second + " Hz");
			Console.WriteLine ("First run: " + time1 + " cycles\t(" + (time1 / (cycles_per_second / 1000000)) + " micros)");
			Console.WriteLine ("Second run: " + time2 + " cycles\t(" + (time2 / (cycles_per_second / 1000000)) + " micros)");
			Console.WriteLine ("Loop run1: " + time3 + " cycles\t(" + (time3 / (cycles_per_second / 1000000)) + " micros)");
			Console.WriteLine ("Loop run2: " + time4 + " cycles\t(" + (time4 / (cycles_per_second / 1000000)) + " micros)");

			// Print sum in order to avoid that the compiler removes code
			Console.WriteLine ("Sum: " + sum);
		
			/* write execution times to file */
			//outfile = File.AppendText (args [0]);
			outfile.WriteLine ((time1 / (cycles_per_second / 1000000)) + "\t" +
					(time2 / (cycles_per_second / 1000000)) + "\t" +
					(time3 / (cycles_per_second / 1000000)) + "\t" +
					(time4 / (cycles_per_second / 1000000)));
			outfile.Close ();
			return sum;
		}

		static int method0 (int var497, int var378)
		{
			if (var497 > var378)
		...
		static int method1 (int var149, int var862)
		{
			if (var149 > var862)
		...
		static int method2 (int var813, int var523)
		{
			if (var813 > var523)
		...
		static int method3 (int var202, int var886)
		{
			if (var202 > var886)
		...
		static int method4 (int var79, int var737)
		{
			if (var79 > var737)
				return var79 + var737;
			else
		...
		static int method5 (int var920, int var915)
		{
			if (var920 > var915)
		...
		static int method6 (int var638, int var734)
		{
			if (var638 > var734)
		...
		static int method7 (int var118, int var619)
		{
			if (var118 > var619)
		...
		static int method8 (int var208, int var599)
		{
			if (var208 > var599)
		...
		static int method9 (int var959, int var52)
		{
			if (var959 > var52)
				return var959 - var52;
			else
		...
		static int method10 (int var672, int var714)
		{
			if (var672 > var714)
		...
		static int method11 (int var703, int var798)
		{
			if (var703 > var798)
		...
		static int method12 (int var492, int var254)
		{
			if (var492 > var254)
		...
		static int method13 (int var218, int var151)
		{
			if (var218 > var151)
		...
		static int method14 (int var170, int var485)
		{
			if (var170 > var485)
		...
		static int method15 (int var903, int var114)
		{
			if (var903 > var114)
		...
		static int method16 (int var850, int var994)
		{
			if (var850 > var994)
		...
		static int method17 (int var182, int var931)
		{
			if (var182 > var931)
		...
		static int method18 (int var244, int var704)
		{
			if (var244 > var704)
		...
		static int method19 (int var696, int var280)
		{
			if (var696 > var280)
		...
		static int method20 (int var564, int var552)
		{
			if (var564 > var552)
		...
		static int method21 (int var716, int var698)
		{
			if (var716 > var698)
		...
		static int method22 (int var749, int var863)
		{
			if (var749 > var863)
		...
		static int method23 (int var870, int var407)
		{
			if (var870 > var407)
		...
		static int method24 (int var469, int var750)
		{
			if (var469 > var750)
		...
		static int method25 (int var101, int var702)
		{
			if (var101 > var702)
		...
		static int method26 (int var690, int var435)
		{
			if (var690 > var435)
		...
		static int method27 (int var435, int var424)
		{
			if (var435 > var424)
		...
		static int method28 (int var736, int var220)
		{
			if (var736 > var220)
		...
		static int method29 (int var243, int var127)
		{
			if (var243 > var127)
		...
		static int method30 (int var524, int var64)
		{
			if (var524 > var64)
				return var524 * var64;
			else
		...
		static int method31 (int var830, int var449)
		{
			if (var830 > var449)
		...
		static int method32 (int var14, int var413)
		{
			if (var14 > var413)
				return var14 - var413;
			else
		...
		static int method33 (int var844, int var858)
		{
			if (var844 > var858)
		...
		static int method34 (int var816, int var100)
		{
			if (var816 > var100)
		...
		static int method35 (int var454, int var353)
		{
			if (var454 > var353)
		...
		static int method36 (int var339, int var641)
		{
			if (var339 > var641)
		...
		static int method37 (int var577, int var501)
		{
			if (var577 > var501)
		...
		static int method38 (int var735, int var683)
		{
			if (var735 > var683)
		...
		static int method39 (int var858, int var47)
		{
			if (var858 > var47)
				return var858 * var47;
			else
		...
		static int method40 (int var618, int var503)
		{
			if (var618 > var503)
		...
		static int method41 (int var970, int var646)
		{
			if (var970 > var646)
		...
		static int method42 (int var880, int var283)
		{
			if (var880 > var283)
		...
		static int method43 (int var550, int var255)
		{
			if (var550 > var255)
		...
		static int method44 (int var328, int var478)
		{
			if (var328 > var478)
		...
		static int method45 (int var591, int var936)
		{
			if (var591 > var936)
		...
		static int method46 (int var794, int var885)
		{
			if (var794 > var885)
		...
		static int method47 (int var888, int var511)
		{
			if (var888 > var511)
		...
		static int method48 (int var220, int var279)
		{
			if (var220 > var279)
		...
		static int method49 (int var803, int var485)
		{
			if (var803 > var485)
		...
		static int method50 (int var312, int var60)
		{
			if (var312 > var60)
				return var312 * var60;
			else
		...
		static int method51 (int var909, int var860)
		{
			if (var909 > var860)
		...
		static int method52 (int var889, int var434)
		{
			if (var889 > var434)
		...
		static int method53 (int var159, int var666)
		{
			if (var159 > var666)
		...
		static int method54 (int var283, int var887)
		{
			if (var283 > var887)
		...
		static int method55 (int var842, int var443)
		{
			if (var842 > var443)
		...
		static int method56 (int var971, int var601)
		{
			if (var971 > var601)
		...
		static int method57 (int var346, int var410)
		{
			if (var346 > var410)
		...
		static int method58 (int var589, int var719)
		{
			if (var589 > var719)
		...
		static int method59 (int var777, int var63)
		{
			if (var777 > var63)
				return var777 - var63;
			else
		...
		static int method60 (int var601, int var911)
		{
			if (var601 > var911)
		...
		static int method61 (int var668, int var520)
		{
			if (var668 > var520)
		...
		static int method62 (int var308, int var250)
		{
			if (var308 > var250)
		...
		static int method63 (int var139, int var997)
		{
			if (var139 > var997)
		...
		static int method64 (int var471, int var522)
		{
			if (var471 > var522)
		...
		static int method65 (int var83, int var767)
		{
			if (var83 > var767)
				return var83 * var767;
			else
		...
		static int method66 (int var832, int var425)
		{
			if (var832 > var425)
		...
		static int method67 (int var998, int var313)
		{
			if (var998 > var313)
		...
		static int method68 (int var578, int var819)
		{
			if (var578 > var819)
		...
		static int method69 (int var303, int var650)
		{
			if (var303 > var650)
		...
		static int method70 (int var130, int var82)
		{
			if (var130 > var82)
				return var130 * var82;
			else
		...
		static int method71 (int var327, int var365)
		{
			if (var327 > var365)
		...
		static int method72 (int var887, int var931)
		{
			if (var887 > var931)
		...
		static int method73 (int var65, int var70)
		{
			if (var65 > var70)
				return var65 * var70;
			else
		...
		static int method74 (int var332, int var34)
		{
			if (var332 > var34)
				return var332 * var34;
			else
		...
		static int method75 (int var216, int var460)
		{
			if (var216 > var460)
		...
		static int method76 (int var119, int var918)
		{
			if (var119 > var918)
		...
		static int method77 (int var670, int var879)
		{
			if (var670 > var879)
		...
		static int method78 (int var635, int var593)
		{
			if (var635 > var593)
		...
		static int method79 (int var701, int var63)
		{
			if (var701 > var63)
				return var701 + var63;
			else
		...
		static int method80 (int var92, int var46)
		{
			if (var92 > var46)
				return var92 - var46;
			else
		...
		static int method81 (int var96, int var287)
		{
			if (var96 > var287)
				return var96 * var287;
			else
		...
		static int method82 (int var699, int var443)
		{
			if (var699 > var443)
		...
		static int method83 (int var979, int var380)
		{
			if (var979 > var380)
		...
		static int method84 (int var447, int var547)
		{
			if (var447 > var547)
		...
		static int method85 (int var663, int var612)
		{
			if (var663 > var612)
		...
		static int method86 (int var838, int var529)
		{
			if (var838 > var529)
		...
		static int method87 (int var974, int var898)
		{
			if (var974 > var898)
		...
		static int method88 (int var334, int var719)
		{
			if (var334 > var719)
		...
		static int method89 (int var481, int var75)
		{
			if (var481 > var75)
				return var481 * var75;
			else
		...
		static int method90 (int var471, int var447)
		{
			if (var471 > var447)
		...
		static int method91 (int var215, int var214)
		{
			if (var215 > var214)
		...
		static int method92 (int var755, int var147)
		{
			if (var755 > var147)
		...
		static int method93 (int var89, int var869)
		{
			if (var89 > var869)
				return var89 + var869;
			else
		...
		static int method94 (int var711, int var751)
		{
			if (var711 > var751)
		...
		static int method95 (int var806, int var36)
		{
			if (var806 > var36)
				return var806 - var36;
			else
		...
		static int method96 (int var971, int var263)
		{
			if (var971 > var263)
		...
		static int method97 (int var165, int var429)
		{
			if (var165 > var429)
		...
		static int method98 (int var792, int var268)
		{
			if (var792 > var268)
		...
		static int method99 (int var522, int var998)
		{
			if (var522 > var998)
		...
		static int method100 (int var817, int var919)
		{
			if (var817 > var919)
		...
		static int method101 (int var92, int var884)
		{
			if (var92 > var884)
				return var92 * var884;
			else
		...
		static int method102 (int var748, int var987)
		{
			if (var748 > var987)
		...
		static int method103 (int var909, int var767)
		{
			if (var909 > var767)
		...
		static int method104 (int var655, int var361)
		{
			if (var655 > var361)
		...
		static int method105 (int var691, int var970)
		{
			if (var691 > var970)
		...
		static int method106 (int var330, int var350)
		{
			if (var330 > var350)
		...
		static int method107 (int var776, int var992)
		{
			if (var776 > var992)
		...
		static int method108 (int var3, int var798)
		{
			if (var3 > var798)
				return var3 + var798;
			else
		...
		static int method109 (int var127, int var776)
		{
			if (var127 > var776)
		...
		static int method110 (int var608, int var265)
		{
			if (var608 > var265)
		...
		static int method111 (int var737, int var356)
		{
			if (var737 > var356)
		...
		static int method112 (int var938, int var765)
		{
			if (var938 > var765)
		...
		static int method113 (int var221, int var219)
		{
			if (var221 > var219)
		...
		static int method114 (int var915, int var445)
		{
			if (var915 > var445)
		...
		static int method115 (int var757, int var273)
		{
			if (var757 > var273)
		...
		static int method116 (int var378, int var67)
		{
			if (var378 > var67)
				return var378 * var67;
			else
		...
		static int method117 (int var29, int var141)
		{
			if (var29 > var141)
				return var29 * var141;
			else
		...
		static int method118 (int var422, int var403)
		{
			if (var422 > var403)
		...
		static int method119 (int var748, int var114)
		{
			if (var748 > var114)
		...
		static int method120 (int var435, int var982)
		{
			if (var435 > var982)
		...
		static int method121 (int var234, int var176)
		{
			if (var234 > var176)
		...
		static int method122 (int var419, int var735)
		{
			if (var419 > var735)
		...
		static int method123 (int var747, int var236)
		{
			if (var747 > var236)
		...
		static int method124 (int var843, int var123)
		{
			if (var843 > var123)
		...
		static int method125 (int var607, int var451)
		{
			if (var607 > var451)
		...
		static int method126 (int var330, int var581)
		{
			if (var330 > var581)
		...
		static int method127 (int var985, int var712)
		{
			if (var985 > var712)
		...
		static int method128 (int var26, int var300)
		{
			if (var26 > var300)
				return var26 * var300;
			else
		...
		static int method129 (int var526, int var845)
		{
			if (var526 > var845)
		...
		static int method130 (int var224, int var136)
		{
			if (var224 > var136)
		...
		static int method131 (int var533, int var552)
		{
			if (var533 > var552)
		...
		static int method132 (int var73, int var78)
		{
			if (var73 > var78)
				return var73 - var78;
			else
		...
		static int method133 (int var129, int var813)
		{
			if (var129 > var813)
		...
		static int method134 (int var955, int var914)
		{
			if (var955 > var914)
		...
		static int method135 (int var649, int var325)
		{
			if (var649 > var325)
		...
		static int method136 (int var511, int var624)
		{
			if (var511 > var624)
		...
		static int method137 (int var702, int var843)
		{
			if (var702 > var843)
		...
		static int method138 (int var50, int var202)
		{
			if (var50 > var202)
				return var50 + var202;
			else
		...
		static int method139 (int var322, int var35)
		{
			if (var322 > var35)
				return var322 + var35;
			else
		...
		static int method140 (int var625, int var142)
		{
			if (var625 > var142)
		...
		static int method141 (int var63, int var68)
		{
			if (var63 > var68)
				return var63 - var68;
			else
		...
		static int method142 (int var788, int var687)
		{
			if (var788 > var687)
		...
		static int method143 (int var142, int var107)
		{
			if (var142 > var107)
		...
		static int method144 (int var86, int var485)
		{
			if (var86 > var485)
				return var86 + var485;
			else
		...
		static int method145 (int var230, int var393)
		{
			if (var230 > var393)
		...
		static int method146 (int var453, int var218)
		{
			if (var453 > var218)
		...
		static int method147 (int var750, int var303)
		{
			if (var750 > var303)
		...
		static int method148 (int var126, int var706)
		{
			if (var126 > var706)
		...
		static int method149 (int var182, int var597)
		{
			if (var182 > var597)
		...
		static int method150 (int var537, int var985)
		{
			if (var537 > var985)
		...
		static int method151 (int var613, int var507)
		{
			if (var613 > var507)
		...
		static int method152 (int var748, int var739)
		{
			if (var748 > var739)
		...
		static int method153 (int var285, int var498)
		{
			if (var285 > var498)
		...
		static int method154 (int var16, int var417)
		{
			if (var16 > var417)
				return var16 + var417;
			else
		...
		static int method155 (int var885, int var956)
		{
			if (var885 > var956)
		...
		static int method156 (int var149, int var141)
		{
			if (var149 > var141)
		...
		static int method157 (int var494, int var640)
		{
			if (var494 > var640)
		...
		static int method158 (int var736, int var12)
		{
			if (var736 > var12)
				return var736 + var12;
			else
		...
		static int method159 (int var108, int var948)
		{
			if (var108 > var948)
		...
		static int method160 (int var201, int var690)
		{
			if (var201 > var690)
		...
		static int method161 (int var417, int var665)
		{
			if (var417 > var665)
		...
		static int method162 (int var557, int var366)
		{
			if (var557 > var366)
		...
		static int method163 (int var103, int var583)
		{
			if (var103 > var583)
		...
		static int method164 (int var248, int var272)
		{
			if (var248 > var272)
		...
		static int method165 (int var399, int var198)
		{
			if (var399 > var198)
		...
		static int method166 (int var537, int var576)
		{
			if (var537 > var576)
		...
		static int method167 (int var81, int var866)
		{
			if (var81 > var866)
				return var81 - var866;
			else
		...
		static int method168 (int var860, int var474)
		{
			if (var860 > var474)
		...
		static int method169 (int var852, int var847)
		{
			if (var852 > var847)
		...
		static int method170 (int var892, int var932)
		{
			if (var892 > var932)
		...
		static int method171 (int var241, int var285)
		{
			if (var241 > var285)
		...
		static int method172 (int var474, int var313)
		{
			if (var474 > var313)
		...
		static int method173 (int var867, int var521)
		{
			if (var867 > var521)
		...
		static int method174 (int var830, int var464)
		{
			if (var830 > var464)
		...
		static int method175 (int var812, int var22)
		{
			if (var812 > var22)
				return var812 + var22;
			else
		...
		static int method176 (int var473, int var23)
		{
			if (var473 > var23)
				return var473 - var23;
			else
		...
		static int method177 (int var342, int var111)
		{
			if (var342 > var111)
		...
		static int method178 (int var797, int var342)
		{
			if (var797 > var342)
		...
		static int method179 (int var331, int var222)
		{
			if (var331 > var222)
		...
		static int method180 (int var745, int var137)
		{
			if (var745 > var137)
		...
		static int method181 (int var53, int var431)
		{
			if (var53 > var431)
				return var53 * var431;
			else
		...
		static int method182 (int var0, int var924)
		{
			if (var0 > var924)
				return var0 - var924;
			else
		...
		static int method183 (int var505, int var398)
		{
			if (var505 > var398)
		...
		static int method184 (int var134, int var600)
		{
			if (var134 > var600)
		...
		static int method185 (int var953, int var989)
		{
			if (var953 > var989)
		...
		static int method186 (int var567, int var948)
		{
			if (var567 > var948)
		...
		static int method187 (int var467, int var244)
		{
			if (var467 > var244)
		...
		static int method188 (int var463, int var974)
		{
			if (var463 > var974)
		...
		static int method189 (int var517, int var308)
		{
			if (var517 > var308)
		...
		static int method190 (int var888, int var42)
		{
			if (var888 > var42)
				return var888 + var42;
			else
		...
		static int method191 (int var157, int var380)
		{
			if (var157 > var380)
		...
		static int method192 (int var775, int var889)
		{
			if (var775 > var889)
		...
		static int method193 (int var754, int var699)
		{
			if (var754 > var699)
		...
		static int method194 (int var674, int var563)
		{
			if (var674 > var563)
		...
		static int method195 (int var914, int var782)
		{
			if (var914 > var782)
		...
		static int method196 (int var36, int var614)
		{
			if (var36 > var614)
				return var36 - var614;
			else
		...
		static int method197 (int var240, int var816)
		{
			if (var240 > var816)
		...
		static int method198 (int var824, int var843)
		{
			if (var824 > var843)
		...
		static int method199 (int var235, int var474)
		{
			if (var235 > var474)
		...
		static int method200 (int var274, int var567)
		{
			if (var274 > var567)
		...
		static int method201 (int var330, int var529)
		{
			if (var330 > var529)
		...
		static int method202 (int var938, int var844)
		{
			if (var938 > var844)
		...
		static int method203 (int var67, int var976)
		{
			if (var67 > var976)
				return var67 + var976;
			else
		...
		static int method204 (int var217, int var957)
		{
			if (var217 > var957)
		...
		static int method205 (int var144, int var483)
		{
			if (var144 > var483)
		...
		static int method206 (int var614, int var29)
		{
			if (var614 > var29)
				return var614 * var29;
			else
		...
		static int method207 (int var369, int var293)
		{
			if (var369 > var293)
		...
		static int method208 (int var625, int var660)
		{
			if (var625 > var660)
		...
		static int method209 (int var715, int var100)
		{
			if (var715 > var100)
		...
		static int method210 (int var397, int var561)
		{
			if (var397 > var561)
		...
		static int method211 (int var672, int var321)
		{
			if (var672 > var321)
		...
		static int method212 (int var228, int var885)
		{
			if (var228 > var885)
		...
		static int method213 (int var104, int var224)
		{
			if (var104 > var224)
		...
		static int method214 (int var942, int var736)
		{
			if (var942 > var736)
		...
		static int method215 (int var813, int var783)
		{
			if (var813 > var783)
		...
		static int method216 (int var447, int var412)
		{
			if (var447 > var412)
		...
		static int method217 (int var304, int var586)
		{
			if (var304 > var586)
		...
		static int method218 (int var728, int var29)
		{
			if (var728 > var29)
				return var728 * var29;
			else
		...
		static int method219 (int var378, int var714)
		{
			if (var378 > var714)
		...
		static int method220 (int var87, int var293)
		{
			if (var87 > var293)
				return var87 - var293;
			else
		...
		static int method221 (int var479, int var118)
		{
			if (var479 > var118)
		...
		static int method222 (int var213, int var174)
		{
			if (var213 > var174)
		...
		static int method223 (int var795, int var794)
		{
			if (var795 > var794)
		...
		static int method224 (int var833, int var731)
		{
			if (var833 > var731)
		...
		static int method225 (int var942, int var23)
		{
			if (var942 > var23)
				return var942 + var23;
			else
		...
		static int method226 (int var798, int var200)
		{
			if (var798 > var200)
		...
		static int method227 (int var744, int var761)
		{
			if (var744 > var761)
		...
		static int method228 (int var523, int var146)
		{
			if (var523 > var146)
		...
		static int method229 (int var987, int var998)
		{
			if (var987 > var998)
		...
		static int method230 (int var579, int var349)
		{
			if (var579 > var349)
		...
		static int method231 (int var644, int var448)
		{
			if (var644 > var448)
		...
		static int method232 (int var230, int var937)
		{
			if (var230 > var937)
		...
		static int method233 (int var969, int var352)
		{
			if (var969 > var352)
		...
		static int method234 (int var770, int var378)
		{
			if (var770 > var378)
		...
		static int method235 (int var131, int var708)
		{
			if (var131 > var708)
		...
		static int method236 (int var594, int var641)
		{
			if (var594 > var641)
		...
		static int method237 (int var150, int var905)
		{
			if (var150 > var905)
		...
		static int method238 (int var500, int var532)
		{
			if (var500 > var532)
		...
		static int method239 (int var53, int var365)
		{
			if (var53 > var365)
				return var53 - var365;
			else
		...
		static int method240 (int var429, int var483)
		{
			if (var429 > var483)
		...
		static int method241 (int var630, int var360)
		{
			if (var630 > var360)
		...
		static int method242 (int var551, int var625)
		{
			if (var551 > var625)
		...
		static int method243 (int var847, int var852)
		{
			if (var847 > var852)
		...
		static int method244 (int var849, int var456)
		{
			if (var849 > var456)
		...
		static int method245 (int var394, int var303)
		{
			if (var394 > var303)
		...
		static int method246 (int var507, int var408)
		{
			if (var507 > var408)
		...
		static int method247 (int var722, int var411)
		{
			if (var722 > var411)
		...
		static int method248 (int var827, int var219)
		{
			if (var827 > var219)
		...
		static int method249 (int var860, int var902)
		{
			if (var860 > var902)
		...
		static int method250 (int var791, int var810)
		{
			if (var791 > var810)
		...
		static int method251 (int var511, int var38)
		{
			if (var511 > var38)
				return var511 + var38;
			else
		...
		static int method252 (int var25, int var614)
		{
			if (var25 > var614)
				return var25 * var614;
			else
		...
		static int method253 (int var642, int var204)
		{
			if (var642 > var204)
		...
		static int method254 (int var656, int var928)
		{
			if (var656 > var928)
		...
		static int method255 (int var499, int var771)
		{
			if (var499 > var771)
		...
		static int method256 (int var834, int var481)
		{
			if (var834 > var481)
		...
		static int method257 (int var341, int var54)
		{
			if (var341 > var54)
				return var341 * var54;
			else
		...
		static int method258 (int var430, int var749)
		{
			if (var430 > var749)
		...
		static int method259 (int var660, int var518)
		{
			if (var660 > var518)
		...
		static int method260 (int var752, int var309)
		{
			if (var752 > var309)
		...
		static int method261 (int var912, int var212)
		{
			if (var912 > var212)
		...
		static int method262 (int var385, int var148)
		{
			if (var385 > var148)
		...
		static int method263 (int var560, int var629)
		{
			if (var560 > var629)
		...
		static int method264 (int var379, int var293)
		{
			if (var379 > var293)
		...
		static int method265 (int var378, int var251)
		{
			if (var378 > var251)
		...
		static int method266 (int var862, int var8)
		{
			if (var862 > var8)
				return var862 + var8;
			else
		...
		static int method267 (int var292, int var942)
		{
			if (var292 > var942)
		...
		static int method268 (int var543, int var45)
		{
			if (var543 > var45)
				return var543 * var45;
			else
		...
		static int method269 (int var210, int var432)
		{
			if (var210 > var432)
		...
		static int method270 (int var101, int var243)
		{
			if (var101 > var243)
		...
		static int method271 (int var676, int var64)
		{
			if (var676 > var64)
				return var676 + var64;
			else
		...
		static int method272 (int var887, int var760)
		{
			if (var887 > var760)
		...
		static int method273 (int var225, int var991)
		{
			if (var225 > var991)
		...
		static int method274 (int var766, int var906)
		{
			if (var766 > var906)
		...
		static int method275 (int var1, int var531)
		{
			if (var1 > var531)
				return var1 + var531;
			else
		...
		static int method276 (int var46, int var771)
		{
			if (var46 > var771)
				return var46 - var771;
			else
		...
		static int method277 (int var952, int var127)
		{
			if (var952 > var127)
		...
		static int method278 (int var406, int var532)
		{
			if (var406 > var532)
		...
		static int method279 (int var25, int var483)
		{
			if (var25 > var483)
				return var25 * var483;
			else
		...
		static int method280 (int var242, int var50)
		{
			if (var242 > var50)
				return var242 - var50;
			else
		...
		static int method281 (int var940, int var909)
		{
			if (var940 > var909)
		...
		static int method282 (int var999, int var291)
		{
			if (var999 > var291)
		...
		static int method283 (int var479, int var723)
		{
			if (var479 > var723)
		...
		static int method284 (int var837, int var959)
		{
			if (var837 > var959)
		...
		static int method285 (int var39, int var480)
		{
			if (var39 > var480)
				return var39 * var480;
			else
		...
		static int method286 (int var518, int var480)
		{
			if (var518 > var480)
		...
		static int method287 (int var50, int var752)
		{
			if (var50 > var752)
				return var50 + var752;
			else
		...
		static int method288 (int var906, int var288)
		{
			if (var906 > var288)
		...
		static int method289 (int var51, int var209)
		{
			if (var51 > var209)
				return var51 + var209;
			else
		...
		static int method290 (int var934, int var625)
		{
			if (var934 > var625)
		...
		static int method291 (int var88, int var907)
		{
			if (var88 > var907)
				return var88 - var907;
			else
		...
		static int method292 (int var13, int var14)
		{
			if (var13 > var14)
				return var13 - var14;
			else
		...
		static int method293 (int var432, int var506)
		{
			if (var432 > var506)
		...
		static int method294 (int var143, int var129)
		{
			if (var143 > var129)
		...
		static int method295 (int var858, int var730)
		{
			if (var858 > var730)
		...
		static int method296 (int var356, int var214)
		{
			if (var356 > var214)
		...
		static int method297 (int var635, int var187)
		{
			if (var635 > var187)
		...
		static int method298 (int var945, int var807)
		{
			if (var945 > var807)
		...
		static int method299 (int var47, int var742)
		{
			if (var47 > var742)
				return var47 + var742;
			else
		...
		static int method300 (int var336, int var113)
		{
			if (var336 > var113)
		...
		static int method301 (int var894, int var208)
		{
			if (var894 > var208)
		...
		static int method302 (int var931, int var434)
		{
			if (var931 > var434)
		...
		static int method303 (int var574, int var621)
		{
			if (var574 > var621)
		...
		static int method304 (int var679, int var613)
		{
			if (var679 > var613)
		...
		static int method305 (int var859, int var878)
		{
			if (var859 > var878)
		...
		static int method306 (int var677, int var359)
		{
			if (var677 > var359)
		...
		static int method307 (int var612, int var835)
		{
			if (var612 > var835)
		...
		static int method308 (int var198, int var721)
		{
			if (var198 > var721)
		...
		static int method309 (int var156, int var209)
		{
			if (var156 > var209)
		...
		static int method310 (int var535, int var931)
		{
			if (var535 > var931)
		...
		static int method311 (int var327, int var731)
		{
			if (var327 > var731)
		...
		static int method312 (int var130, int var126)
		{
			if (var130 > var126)
		...
		static int method313 (int var130, int var23)
		{
			if (var130 > var23)
				return var130 - var23;
			else
		...
		static int method314 (int var915, int var543)
		{
			if (var915 > var543)
		...
		static int method315 (int var52, int var84)
		{
			if (var52 > var84)
				return var52 + var84;
			else
		...
		static int method316 (int var899, int var557)
		{
			if (var899 > var557)
		...
		static int method317 (int var293, int var472)
		{
			if (var293 > var472)
		...
		static int method318 (int var483, int var379)
		{
			if (var483 > var379)
		...
		static int method319 (int var748, int var619)
		{
			if (var748 > var619)
		...
		static int method320 (int var444, int var796)
		{
			if (var444 > var796)
		...
		static int method321 (int var783, int var736)
		{
			if (var783 > var736)
		...
		static int method322 (int var822, int var859)
		{
			if (var822 > var859)
		...
		static int method323 (int var916, int var507)
		{
			if (var916 > var507)
		...
		static int method324 (int var448, int var601)
		{
			if (var448 > var601)
		...
		static int method325 (int var982, int var71)
		{
			if (var982 > var71)
				return var982 * var71;
			else
		...
		static int method326 (int var682, int var298)
		{
			if (var682 > var298)
		...
		static int method327 (int var240, int var845)
		{
			if (var240 > var845)
		...
		static int method328 (int var720, int var868)
		{
			if (var720 > var868)
		...
		static int method329 (int var168, int var234)
		{
			if (var168 > var234)
		...
		static int method330 (int var109, int var982)
		{
			if (var109 > var982)
		...
		static int method331 (int var490, int var836)
		{
			if (var490 > var836)
		...
		static int method332 (int var696, int var261)
		{
			if (var696 > var261)
		...
		static int method333 (int var379, int var183)
		{
			if (var379 > var183)
		...
		static int method334 (int var75, int var692)
		{
			if (var75 > var692)
				return var75 * var692;
			else
		...
		static int method335 (int var567, int var444)
		{
			if (var567 > var444)
		...
		static int method336 (int var749, int var728)
		{
			if (var749 > var728)
		...
		static int method337 (int var17, int var11)
		{
			if (var17 > var11)
				return var17 * var11;
			else
		...
		static int method338 (int var904, int var159)
		{
			if (var904 > var159)
		...
		static int method339 (int var691, int var122)
		{
			if (var691 > var122)
		...
		static int method340 (int var222, int var506)
		{
			if (var222 > var506)
		...
		static int method341 (int var277, int var791)
		{
			if (var277 > var791)
		...
		static int method342 (int var118, int var162)
		{
			if (var118 > var162)
		...
		static int method343 (int var217, int var314)
		{
			if (var217 > var314)
		...
		static int method344 (int var77, int var13)
		{
			if (var77 > var13)
				return var77 + var13;
			else
		...
		static int method345 (int var144, int var915)
		{
			if (var144 > var915)
		...
		static int method346 (int var39, int var395)
		{
			if (var39 > var395)
				return var39 - var395;
			else
		...
		static int method347 (int var906, int var735)
		{
			if (var906 > var735)
		...
		static int method348 (int var573, int var959)
		{
			if (var573 > var959)
		...
		static int method349 (int var226, int var383)
		{
			if (var226 > var383)
		...
		static int method350 (int var650, int var377)
		{
			if (var650 > var377)
		...
		static int method351 (int var867, int var237)
		{
			if (var867 > var237)
		...
		static int method352 (int var120, int var929)
		{
			if (var120 > var929)
		...
		static int method353 (int var216, int var106)
		{
			if (var216 > var106)
		...
		static int method354 (int var933, int var38)
		{
			if (var933 > var38)
				return var933 + var38;
			else
		...
		static int method355 (int var564, int var810)
		{
			if (var564 > var810)
		...
		static int method356 (int var511, int var722)
		{
			if (var511 > var722)
		...
		static int method357 (int var446, int var318)
		{
			if (var446 > var318)
		...
		static int method358 (int var893, int var811)
		{
			if (var893 > var811)
		...
		static int method359 (int var698, int var168)
		{
			if (var698 > var168)
		...
		static int method360 (int var462, int var594)
		{
			if (var462 > var594)
		...
		static int method361 (int var170, int var547)
		{
			if (var170 > var547)
		...
		static int method362 (int var447, int var471)
		{
			if (var447 > var471)
		...
		static int method363 (int var936, int var239)
		{
			if (var936 > var239)
		...
		static int method364 (int var484, int var297)
		{
			if (var484 > var297)
		...
		static int method365 (int var539, int var890)
		{
			if (var539 > var890)
		...
		static int method366 (int var467, int var125)
		{
			if (var467 > var125)
		...
		static int method367 (int var935, int var224)
		{
			if (var935 > var224)
		...
		static int method368 (int var590, int var281)
		{
			if (var590 > var281)
		...
		static int method369 (int var874, int var808)
		{
			if (var874 > var808)
		...
		static int method370 (int var238, int var913)
		{
			if (var238 > var913)
		...
		static int method371 (int var779, int var828)
		{
			if (var779 > var828)
		...
		static int method372 (int var343, int var290)
		{
			if (var343 > var290)
		...
		static int method373 (int var232, int var570)
		{
			if (var232 > var570)
		...
		static int method374 (int var3, int var399)
		{
			if (var3 > var399)
				return var3 + var399;
			else
		...
		static int method375 (int var672, int var611)
		{
			if (var672 > var611)
		...
		static int method376 (int var233, int var125)
		{
			if (var233 > var125)
		...
		static int method377 (int var460, int var425)
		{
			if (var460 > var425)
		...
		static int method378 (int var953, int var172)
		{
			if (var953 > var172)
		...
		static int method379 (int var657, int var971)
		{
			if (var657 > var971)
		...
		static int method380 (int var122, int var179)
		{
			if (var122 > var179)
		...
		static int method381 (int var551, int var722)
		{
			if (var551 > var722)
		...
		static int method382 (int var47, int var865)
		{
			if (var47 > var865)
				return var47 - var865;
			else
		...
		static int method383 (int var348, int var466)
		{
			if (var348 > var466)
		...
		static int method384 (int var959, int var703)
		{
			if (var959 > var703)
		...
		static int method385 (int var170, int var224)
		{
			if (var170 > var224)
		...
		static int method386 (int var168, int var128)
		{
			if (var168 > var128)
		...
		static int method387 (int var19, int var228)
		{
			if (var19 > var228)
				return var19 + var228;
			else
		...
		static int method388 (int var351, int var22)
		{
			if (var351 > var22)
				return var351 + var22;
			else
		...
		static int method389 (int var263, int var67)
		{
			if (var263 > var67)
				return var263 + var67;
			else
		...
		static int method390 (int var165, int var310)
		{
			if (var165 > var310)
		...
		static int method391 (int var254, int var489)
		{
			if (var254 > var489)
		...
		static int method392 (int var3, int var544)
		{
			if (var3 > var544)
				return var3 * var544;
			else
		...
		static int method393 (int var952, int var655)
		{
			if (var952 > var655)
		...
		static int method394 (int var827, int var428)
		{
			if (var827 > var428)
		...
		static int method395 (int var459, int var903)
		{
			if (var459 > var903)
		...
		static int method396 (int var699, int var351)
		{
			if (var699 > var351)
		...
		static int method397 (int var212, int var395)
		{
			if (var212 > var395)
		...
		static int method398 (int var699, int var248)
		{
			if (var699 > var248)
		...
		static int method399 (int var272, int var518)
		{
			if (var272 > var518)
		...
		static int method400 (int var300, int var478)
		{
			if (var300 > var478)
		...
		static int method401 (int var769, int var80)
		{
			if (var769 > var80)
				return var769 - var80;
			else
		...
		static int method402 (int var323, int var480)
		{
			if (var323 > var480)
		...
		static int method403 (int var855, int var566)
		{
			if (var855 > var566)
		...
		static int method404 (int var610, int var429)
		{
			if (var610 > var429)
		...
		static int method405 (int var217, int var733)
		{
			if (var217 > var733)
		...
		static int method406 (int var243, int var793)
		{
			if (var243 > var793)
		...
		static int method407 (int var886, int var445)
		{
			if (var886 > var445)
		...
		static int method408 (int var105, int var127)
		{
			if (var105 > var127)
		...
		static int method409 (int var48, int var214)
		{
			if (var48 > var214)
				return var48 + var214;
			else
		...
		static int method410 (int var740, int var296)
		{
			if (var740 > var296)
		...
		static int method411 (int var178, int var826)
		{
			if (var178 > var826)
		...
		static int method412 (int var4, int var534)
		{
			if (var4 > var534)
				return var4 - var534;
			else
		...
		static int method413 (int var631, int var859)
		{
			if (var631 > var859)
		...
		static int method414 (int var373, int var56)
		{
			if (var373 > var56)
				return var373 + var56;
			else
		...
		static int method415 (int var32, int var265)
		{
			if (var32 > var265)
				return var32 + var265;
			else
		...
		static int method416 (int var740, int var246)
		{
			if (var740 > var246)
		...
		static int method417 (int var387, int var33)
		{
			if (var387 > var33)
				return var387 * var33;
			else
		...
		static int method418 (int var424, int var998)
		{
			if (var424 > var998)
		...
		static int method419 (int var101, int var956)
		{
			if (var101 > var956)
		...
		static int method420 (int var420, int var624)
		{
			if (var420 > var624)
		...
		static int method421 (int var413, int var116)
		{
			if (var413 > var116)
		...
		static int method422 (int var387, int var492)
		{
			if (var387 > var492)
		...
		static int method423 (int var826, int var732)
		{
			if (var826 > var732)
		...
		static int method424 (int var871, int var954)
		{
			if (var871 > var954)
		...
		static int method425 (int var725, int var64)
		{
			if (var725 > var64)
				return var725 * var64;
			else
		...
		static int method426 (int var114, int var998)
		{
			if (var114 > var998)
		...
		static int method427 (int var446, int var809)
		{
			if (var446 > var809)
		...
		static int method428 (int var669, int var505)
		{
			if (var669 > var505)
		...
		static int method429 (int var438, int var226)
		{
			if (var438 > var226)
		...
		static int method430 (int var374, int var867)
		{
			if (var374 > var867)
		...
		static int method431 (int var308, int var242)
		{
			if (var308 > var242)
		...
		static int method432 (int var884, int var326)
		{
			if (var884 > var326)
		...
		static int method433 (int var510, int var961)
		{
			if (var510 > var961)
		...
		static int method434 (int var955, int var710)
		{
			if (var955 > var710)
		...
		static int method435 (int var677, int var918)
		{
			if (var677 > var918)
		...
		static int method436 (int var117, int var993)
		{
			if (var117 > var993)
		...
		static int method437 (int var423, int var822)
		{
			if (var423 > var822)
		...
		static int method438 (int var70, int var612)
		{
			if (var70 > var612)
				return var70 + var612;
			else
		...
		static int method439 (int var553, int var270)
		{
			if (var553 > var270)
		...
		static int method440 (int var43, int var129)
		{
			if (var43 > var129)
				return var43 * var129;
			else
		...
		static int method441 (int var131, int var134)
		{
			if (var131 > var134)
		...
		static int method442 (int var388, int var230)
		{
			if (var388 > var230)
		...
		static int method443 (int var802, int var64)
		{
			if (var802 > var64)
				return var802 + var64;
			else
		...
		static int method444 (int var796, int var40)
		{
			if (var796 > var40)
				return var796 + var40;
			else
		...
		static int method445 (int var688, int var103)
		{
			if (var688 > var103)
		...
		static int method446 (int var282, int var190)
		{
			if (var282 > var190)
		...
		static int method447 (int var830, int var857)
		{
			if (var830 > var857)
		...
		static int method448 (int var322, int var345)
		{
			if (var322 > var345)
		...
		static int method449 (int var116, int var201)
		{
			if (var116 > var201)
		...
		static int method450 (int var197, int var762)
		{
			if (var197 > var762)
		...
		static int method451 (int var133, int var655)
		{
			if (var133 > var655)
		...
		static int method452 (int var329, int var508)
		{
			if (var329 > var508)
		...
		static int method453 (int var440, int var108)
		{
			if (var440 > var108)
		...
		static int method454 (int var806, int var909)
		{
			if (var806 > var909)
		...
		static int method455 (int var18, int var750)
		{
			if (var18 > var750)
				return var18 + var750;
			else
		...
		static int method456 (int var33, int var8)
		{
			if (var33 > var8)
				return var33 * var8;
			else
		...
		static int method457 (int var931, int var192)
		{
			if (var931 > var192)
		...
		static int method458 (int var711, int var162)
		{
			if (var711 > var162)
		...
		static int method459 (int var662, int var389)
		{
			if (var662 > var389)
		...
		static int method460 (int var383, int var106)
		{
			if (var383 > var106)
		...
		static int method461 (int var839, int var498)
		{
			if (var839 > var498)
		...
		static int method462 (int var311, int var57)
		{
			if (var311 > var57)
				return var311 - var57;
			else
		...
		static int method463 (int var270, int var741)
		{
			if (var270 > var741)
		...
		static int method464 (int var51, int var623)
		{
			if (var51 > var623)
				return var51 * var623;
			else
		...
		static int method465 (int var992, int var517)
		{
			if (var992 > var517)
		...
		static int method466 (int var124, int var333)
		{
			if (var124 > var333)
		...
		static int method467 (int var269, int var166)
		{
			if (var269 > var166)
		...
		static int method468 (int var597, int var483)
		{
			if (var597 > var483)
		...
		static int method469 (int var480, int var214)
		{
			if (var480 > var214)
		...
		static int method470 (int var957, int var571)
		{
			if (var957 > var571)
		...
		static int method471 (int var199, int var542)
		{
			if (var199 > var542)
		...
		static int method472 (int var38, int var81)
		{
			if (var38 > var81)
				return var38 + var81;
			else
		...
		static int method473 (int var120, int var140)
		{
			if (var120 > var140)
		...
		static int method474 (int var508, int var878)
		{
			if (var508 > var878)
		...
		static int method475 (int var18, int var897)
		{
			if (var18 > var897)
				return var18 + var897;
			else
		...
		static int method476 (int var100, int var929)
		{
			if (var100 > var929)
		...
		static int method477 (int var541, int var545)
		{
			if (var541 > var545)
		...
		static int method478 (int var585, int var74)
		{
			if (var585 > var74)
				return var585 - var74;
			else
		...
		static int method479 (int var397, int var652)
		{
			if (var397 > var652)
		...
		static int method480 (int var825, int var410)
		{
			if (var825 > var410)
		...
		static int method481 (int var148, int var968)
		{
			if (var148 > var968)
		...
		static int method482 (int var382, int var6)
		{
			if (var382 > var6)
				return var382 * var6;
			else
		...
		static int method483 (int var672, int var605)
		{
			if (var672 > var605)
		...
		static int method484 (int var985, int var2)
		{
			if (var985 > var2)
				return var985 - var2;
			else
		...
		static int method485 (int var145, int var252)
		{
			if (var145 > var252)
		...
		static int method486 (int var256, int var338)
		{
			if (var256 > var338)
		...
		static int method487 (int var991, int var472)
		{
			if (var991 > var472)
		...
		static int method488 (int var496, int var452)
		{
			if (var496 > var452)
		...
		static int method489 (int var224, int var325)
		{
			if (var224 > var325)
		...
		static int method490 (int var943, int var803)
		{
			if (var943 > var803)
		...
		static int method491 (int var400, int var342)
		{
			if (var400 > var342)
		...
		static int method492 (int var817, int var7)
		{
			if (var817 > var7)
				return var817 - var7;
			else
		...
		static int method493 (int var660, int var110)
		{
			if (var660 > var110)
		...
		static int method494 (int var914, int var135)
		{
			if (var914 > var135)
		...
		static int method495 (int var744, int var466)
		{
			if (var744 > var466)
		...
		static int method496 (int var62, int var524)
		{
			if (var62 > var524)
				return var62 * var524;
			else
		...
		static int method497 (int var205, int var596)
		{
			if (var205 > var596)
		...
		static int method498 (int var185, int var481)
		{
			if (var185 > var481)
		...
		static int method499 (int var591, int var993)
		{
			if (var591 > var993)
		...
		static int method500 (int var424, int var892)
		{
			if (var424 > var892)
		...
		static int method501 (int var728, int var401)
		{
			if (var728 > var401)
		...
		static int method502 (int var389, int var851)
		{
			if (var389 > var851)
		...
		static int method503 (int var120, int var241)
		{
			if (var120 > var241)
		...
		static int method504 (int var618, int var463)
		{
			if (var618 > var463)
		...
		static int method505 (int var751, int var265)
		{
			if (var751 > var265)
		...
		static int method506 (int var582, int var456)
		{
			if (var582 > var456)
		...
		static int method507 (int var382, int var195)
		{
			if (var382 > var195)
		...
		static int method508 (int var745, int var336)
		{
			if (var745 > var336)
		...
		static int method509 (int var346, int var740)
		{
			if (var346 > var740)
		...
		static int method510 (int var905, int var635)
		{
			if (var905 > var635)
		...
		static int method511 (int var845, int var68)
		{
			if (var845 > var68)
				return var845 + var68;
			else
		...
		static int method512 (int var899, int var18)
		{
			if (var899 > var18)
				return var899 + var18;
			else
		...
		static int method513 (int var610, int var782)
		{
			if (var610 > var782)
		...
		static int method514 (int var146, int var29)
		{
			if (var146 > var29)
				return var146 - var29;
			else
		...
		static int method515 (int var55, int var965)
		{
			if (var55 > var965)
				return var55 + var965;
			else
		...
		static int method516 (int var945, int var237)
		{
			if (var945 > var237)
		...
		static int method517 (int var395, int var104)
		{
			if (var395 > var104)
		...
		static int method518 (int var564, int var225)
		{
			if (var564 > var225)
		...
		static int method519 (int var654, int var252)
		{
			if (var654 > var252)
		...
		static int method520 (int var309, int var444)
		{
			if (var309 > var444)
		...
		static int method521 (int var140, int var464)
		{
			if (var140 > var464)
		...
		static int method522 (int var391, int var65)
		{
			if (var391 > var65)
				return var391 + var65;
			else
		...
		static int method523 (int var344, int var596)
		{
			if (var344 > var596)
		...
		static int method524 (int var71, int var485)
		{
			if (var71 > var485)
				return var71 + var485;
			else
		...
		static int method525 (int var413, int var688)
		{
			if (var413 > var688)
		...
		static int method526 (int var708, int var383)
		{
			if (var708 > var383)
		...
		static int method527 (int var642, int var223)
		{
			if (var642 > var223)
		...
		static int method528 (int var638, int var447)
		{
			if (var638 > var447)
		...
		static int method529 (int var621, int var322)
		{
			if (var621 > var322)
		...
		static int method530 (int var165, int var72)
		{
			if (var165 > var72)
				return var165 * var72;
			else
		...
		static int method531 (int var690, int var340)
		{
			if (var690 > var340)
		...
		static int method532 (int var516, int var884)
		{
			if (var516 > var884)
		...
		static int method533 (int var609, int var786)
		{
			if (var609 > var786)
		...
		static int method534 (int var806, int var884)
		{
			if (var806 > var884)
		...
		static int method535 (int var843, int var51)
		{
			if (var843 > var51)
				return var843 * var51;
			else
		...
		static int method536 (int var899, int var843)
		{
			if (var899 > var843)
		...
		static int method537 (int var905, int var723)
		{
			if (var905 > var723)
		...
		static int method538 (int var969, int var956)
		{
			if (var969 > var956)
		...
		static int method539 (int var78, int var690)
		{
			if (var78 > var690)
				return var78 + var690;
			else
		...
		static int method540 (int var577, int var530)
		{
			if (var577 > var530)
		...
		static int method541 (int var379, int var705)
		{
			if (var379 > var705)
		...
		static int method542 (int var548, int var494)
		{
			if (var548 > var494)
		...
		static int method543 (int var416, int var507)
		{
			if (var416 > var507)
		...
		static int method544 (int var103, int var213)
		{
			if (var103 > var213)
		...
		static int method545 (int var262, int var964)
		{
			if (var262 > var964)
		...
		static int method546 (int var306, int var60)
		{
			if (var306 > var60)
				return var306 - var60;
			else
		...
		static int method547 (int var406, int var988)
		{
			if (var406 > var988)
		...
		static int method548 (int var335, int var297)
		{
			if (var335 > var297)
		...
		static int method549 (int var634, int var710)
		{
			if (var634 > var710)
		...
		static int method550 (int var740, int var951)
		{
			if (var740 > var951)
		...
		static int method551 (int var461, int var154)
		{
			if (var461 > var154)
		...
		static int method552 (int var649, int var190)
		{
			if (var649 > var190)
		...
		static int method553 (int var283, int var764)
		{
			if (var283 > var764)
		...
		static int method554 (int var194, int var393)
		{
			if (var194 > var393)
		...
		static int method555 (int var70, int var768)
		{
			if (var70 > var768)
				return var70 * var768;
			else
		...
		static int method556 (int var754, int var604)
		{
			if (var754 > var604)
		...
		static int method557 (int var46, int var898)
		{
			if (var46 > var898)
				return var46 - var898;
			else
		...
		static int method558 (int var563, int var113)
		{
			if (var563 > var113)
		...
		static int method559 (int var681, int var599)
		{
			if (var681 > var599)
		...
		static int method560 (int var865, int var89)
		{
			if (var865 > var89)
				return var865 * var89;
			else
		...
		static int method561 (int var917, int var366)
		{
			if (var917 > var366)
		...
		static int method562 (int var543, int var259)
		{
			if (var543 > var259)
		...
		static int method563 (int var664, int var268)
		{
			if (var664 > var268)
		...
		static int method564 (int var387, int var372)
		{
			if (var387 > var372)
		...
		static int method565 (int var473, int var991)
		{
			if (var473 > var991)
		...
		static int method566 (int var324, int var669)
		{
			if (var324 > var669)
		...
		static int method567 (int var846, int var593)
		{
			if (var846 > var593)
		...
		static int method568 (int var849, int var99)
		{
			if (var849 > var99)
				return var849 + var99;
			else
		...
		static int method569 (int var104, int var984)
		{
			if (var104 > var984)
		...
		static int method570 (int var216, int var972)
		{
			if (var216 > var972)
		...
		static int method571 (int var424, int var630)
		{
			if (var424 > var630)
		...
		static int method572 (int var789, int var21)
		{
			if (var789 > var21)
				return var789 + var21;
			else
		...
		static int method573 (int var752, int var867)
		{
			if (var752 > var867)
		...
		static int method574 (int var239, int var928)
		{
			if (var239 > var928)
		...
		static int method575 (int var262, int var149)
		{
			if (var262 > var149)
		...
		static int method576 (int var42, int var695)
		{
			if (var42 > var695)
				return var42 - var695;
			else
		...
		static int method577 (int var843, int var435)
		{
			if (var843 > var435)
		...
		static int method578 (int var583, int var743)
		{
			if (var583 > var743)
		...
		static int method579 (int var239, int var218)
		{
			if (var239 > var218)
		...
		static int method580 (int var430, int var733)
		{
			if (var430 > var733)
		...
		static int method581 (int var330, int var907)
		{
			if (var330 > var907)
		...
		static int method582 (int var57, int var4)
		{
			if (var57 > var4)
				return var57 + var4;
			else
		...
		static int method583 (int var140, int var359)
		{
			if (var140 > var359)
		...
		static int method584 (int var388, int var452)
		{
			if (var388 > var452)
		...
		static int method585 (int var391, int var250)
		{
			if (var391 > var250)
		...
		static int method586 (int var591, int var175)
		{
			if (var591 > var175)
		...
		static int method587 (int var536, int var150)
		{
			if (var536 > var150)
		...
		static int method588 (int var871, int var335)
		{
			if (var871 > var335)
		...
		static int method589 (int var8, int var321)
		{
			if (var8 > var321)
				return var8 * var321;
			else
		...
		static int method590 (int var306, int var25)
		{
			if (var306 > var25)
				return var306 * var25;
			else
		...
		static int method591 (int var44, int var464)
		{
			if (var44 > var464)
				return var44 + var464;
			else
		...
		static int method592 (int var151, int var804)
		{
			if (var151 > var804)
		...
		static int method593 (int var681, int var325)
		{
			if (var681 > var325)
		...
		static int method594 (int var861, int var568)
		{
			if (var861 > var568)
		...
		static int method595 (int var899, int var717)
		{
			if (var899 > var717)
		...
		static int method596 (int var697, int var892)
		{
			if (var697 > var892)
		...
		static int method597 (int var315, int var390)
		{
			if (var315 > var390)
		...
		static int method598 (int var300, int var371)
		{
			if (var300 > var371)
		...
		static int method599 (int var569, int var228)
		{
			if (var569 > var228)
		...
		static int method600 (int var313, int var963)
		{
			if (var313 > var963)
		...
		static int method601 (int var251, int var390)
		{
			if (var251 > var390)
		...
		static int method602 (int var637, int var710)
		{
			if (var637 > var710)
		...
		static int method603 (int var6, int var728)
		{
			if (var6 > var728)
				return var6 * var728;
			else
		...
		static int method604 (int var725, int var960)
		{
			if (var725 > var960)
		...
		static int method605 (int var894, int var576)
		{
			if (var894 > var576)
		...
		static int method606 (int var490, int var541)
		{
			if (var490 > var541)
		...
		static int method607 (int var74, int var679)
		{
			if (var74 > var679)
				return var74 - var679;
			else
		...
		static int method608 (int var931, int var12)
		{
			if (var931 > var12)
				return var931 * var12;
			else
		...
		static int method609 (int var711, int var29)
		{
			if (var711 > var29)
				return var711 + var29;
			else
		...
		static int method610 (int var167, int var304)
		{
			if (var167 > var304)
		...
		static int method611 (int var495, int var475)
		{
			if (var495 > var475)
		...
		static int method612 (int var880, int var342)
		{
			if (var880 > var342)
		...
		static int method613 (int var154, int var863)
		{
			if (var154 > var863)
		...
		static int method614 (int var31, int var690)
		{
			if (var31 > var690)
				return var31 - var690;
			else
		...
		static int method615 (int var678, int var575)
		{
			if (var678 > var575)
		...
		static int method616 (int var543, int var96)
		{
			if (var543 > var96)
				return var543 * var96;
			else
		...
		static int method617 (int var232, int var656)
		{
			if (var232 > var656)
		...
		static int method618 (int var79, int var228)
		{
			if (var79 > var228)
				return var79 + var228;
			else
		...
		static int method619 (int var422, int var566)
		{
			if (var422 > var566)
		...
		static int method620 (int var509, int var418)
		{
			if (var509 > var418)
		...
		static int method621 (int var0, int var886)
		{
			if (var0 > var886)
				return var0 - var886;
			else
		...
		static int method622 (int var468, int var168)
		{
			if (var468 > var168)
		...
		static int method623 (int var797, int var84)
		{
			if (var797 > var84)
				return var797 + var84;
			else
		...
		static int method624 (int var225, int var885)
		{
			if (var225 > var885)
		...
		static int method625 (int var53, int var421)
		{
			if (var53 > var421)
				return var53 * var421;
			else
		...
		static int method626 (int var833, int var49)
		{
			if (var833 > var49)
				return var833 - var49;
			else
		...
		static int method627 (int var862, int var175)
		{
			if (var862 > var175)
		...
		static int method628 (int var222, int var439)
		{
			if (var222 > var439)
		...
		static int method629 (int var778, int var174)
		{
			if (var778 > var174)
		...
		static int method630 (int var870, int var323)
		{
			if (var870 > var323)
		...
		static int method631 (int var602, int var479)
		{
			if (var602 > var479)
		...
		static int method632 (int var395, int var947)
		{
			if (var395 > var947)
		...
		static int method633 (int var703, int var389)
		{
			if (var703 > var389)
		...
		static int method634 (int var196, int var762)
		{
			if (var196 > var762)
		...
		static int method635 (int var108, int var429)
		{
			if (var108 > var429)
		...
		static int method636 (int var297, int var43)
		{
			if (var297 > var43)
				return var297 * var43;
			else
		...
		static int method637 (int var481, int var428)
		{
			if (var481 > var428)
		...
		static int method638 (int var489, int var904)
		{
			if (var489 > var904)
		...
		static int method639 (int var717, int var718)
		{
			if (var717 > var718)
		...
		static int method640 (int var853, int var795)
		{
			if (var853 > var795)
		...
		static int method641 (int var67, int var418)
		{
			if (var67 > var418)
				return var67 + var418;
			else
		...
		static int method642 (int var142, int var264)
		{
			if (var142 > var264)
		...
		static int method643 (int var693, int var492)
		{
			if (var693 > var492)
		...
		static int method644 (int var834, int var400)
		{
			if (var834 > var400)
		...
		static int method645 (int var761, int var224)
		{
			if (var761 > var224)
		...
		static int method646 (int var94, int var782)
		{
			if (var94 > var782)
				return var94 * var782;
			else
		...
		static int method647 (int var322, int var773)
		{
			if (var322 > var773)
		...
		static int method648 (int var620, int var827)
		{
			if (var620 > var827)
		...
		static int method649 (int var735, int var690)
		{
			if (var735 > var690)
		...
		static int method650 (int var209, int var849)
		{
			if (var209 > var849)
		...
		static int method651 (int var666, int var948)
		{
			if (var666 > var948)
		...
		static int method652 (int var810, int var1)
		{
			if (var810 > var1)
				return var810 - var1;
			else
		...
		static int method653 (int var396, int var875)
		{
			if (var396 > var875)
		...
		static int method654 (int var174, int var836)
		{
			if (var174 > var836)
		...
		static int method655 (int var682, int var56)
		{
			if (var682 > var56)
				return var682 - var56;
			else
		...
		static int method656 (int var54, int var25)
		{
			if (var54 > var25)
				return var54 * var25;
			else
		...
		static int method657 (int var825, int var307)
		{
			if (var825 > var307)
		...
		static int method658 (int var590, int var85)
		{
			if (var590 > var85)
				return var590 + var85;
			else
		...
		static int method659 (int var827, int var713)
		{
			if (var827 > var713)
		...
		static int method660 (int var607, int var167)
		{
			if (var607 > var167)
		...
		static int method661 (int var90, int var776)
		{
			if (var90 > var776)
				return var90 - var776;
			else
		...
		static int method662 (int var772, int var976)
		{
			if (var772 > var976)
		...
		static int method663 (int var864, int var478)
		{
			if (var864 > var478)
		...
		static int method664 (int var258, int var752)
		{
			if (var258 > var752)
		...
		static int method665 (int var120, int var683)
		{
			if (var120 > var683)
		...
		static int method666 (int var394, int var215)
		{
			if (var394 > var215)
		...
		static int method667 (int var785, int var642)
		{
			if (var785 > var642)
		...
		static int method668 (int var63, int var7)
		{
			if (var63 > var7)
				return var63 - var7;
			else
		...
		static int method669 (int var192, int var916)
		{
			if (var192 > var916)
		...
		static int method670 (int var766, int var261)
		{
			if (var766 > var261)
		...
		static int method671 (int var186, int var803)
		{
			if (var186 > var803)
		...
		static int method672 (int var691, int var618)
		{
			if (var691 > var618)
		...
		static int method673 (int var927, int var80)
		{
			if (var927 > var80)
				return var927 * var80;
			else
		...
		static int method674 (int var103, int var725)
		{
			if (var103 > var725)
		...
		static int method675 (int var584, int var703)
		{
			if (var584 > var703)
		...
		static int method676 (int var209, int var979)
		{
			if (var209 > var979)
		...
		static int method677 (int var291, int var122)
		{
			if (var291 > var122)
		...
		static int method678 (int var61, int var812)
		{
			if (var61 > var812)
				return var61 - var812;
			else
		...
		static int method679 (int var755, int var543)
		{
			if (var755 > var543)
		...
		static int method680 (int var111, int var540)
		{
			if (var111 > var540)
		...
		static int method681 (int var58, int var513)
		{
			if (var58 > var513)
				return var58 * var513;
			else
		...
		static int method682 (int var797, int var590)
		{
			if (var797 > var590)
		...
		static int method683 (int var624, int var679)
		{
			if (var624 > var679)
		...
		static int method684 (int var200, int var184)
		{
			if (var200 > var184)
		...
		static int method685 (int var47, int var319)
		{
			if (var47 > var319)
				return var47 - var319;
			else
		...
		static int method686 (int var506, int var954)
		{
			if (var506 > var954)
		...
		static int method687 (int var22, int var526)
		{
			if (var22 > var526)
				return var22 * var526;
			else
		...
		static int method688 (int var927, int var349)
		{
			if (var927 > var349)
		...
		static int method689 (int var78, int var408)
		{
			if (var78 > var408)
				return var78 + var408;
			else
		...
		static int method690 (int var779, int var125)
		{
			if (var779 > var125)
		...
		static int method691 (int var75, int var539)
		{
			if (var75 > var539)
				return var75 + var539;
			else
		...
		static int method692 (int var306, int var453)
		{
			if (var306 > var453)
		...
		static int method693 (int var521, int var987)
		{
			if (var521 > var987)
		...
		static int method694 (int var612, int var595)
		{
			if (var612 > var595)
		...
		static int method695 (int var435, int var785)
		{
			if (var435 > var785)
		...
		static int method696 (int var811, int var939)
		{
			if (var811 > var939)
		...
		static int method697 (int var604, int var934)
		{
			if (var604 > var934)
		...
		static int method698 (int var878, int var58)
		{
			if (var878 > var58)
				return var878 + var58;
			else
		...
		static int method699 (int var798, int var537)
		{
			if (var798 > var537)
		...
		static int method700 (int var341, int var401)
		{
			if (var341 > var401)
		...
		static int method701 (int var90, int var345)
		{
			if (var90 > var345)
				return var90 + var345;
			else
		...
		static int method702 (int var538, int var711)
		{
			if (var538 > var711)
		...
		static int method703 (int var804, int var32)
		{
			if (var804 > var32)
				return var804 + var32;
			else
		...
		static int method704 (int var247, int var371)
		{
			if (var247 > var371)
		...
		static int method705 (int var740, int var160)
		{
			if (var740 > var160)
		...
		static int method706 (int var112, int var779)
		{
			if (var112 > var779)
		...
		static int method707 (int var896, int var593)
		{
			if (var896 > var593)
		...
		static int method708 (int var57, int var708)
		{
			if (var57 > var708)
				return var57 * var708;
			else
		...
		static int method709 (int var980, int var624)
		{
			if (var980 > var624)
		...
		static int method710 (int var691, int var447)
		{
			if (var691 > var447)
		...
		static int method711 (int var194, int var687)
		{
			if (var194 > var687)
		...
		static int method712 (int var946, int var47)
		{
			if (var946 > var47)
				return var946 + var47;
			else
		...
		static int method713 (int var640, int var89)
		{
			if (var640 > var89)
				return var640 * var89;
			else
		...
		static int method714 (int var344, int var729)
		{
			if (var344 > var729)
		...
		static int method715 (int var364, int var197)
		{
			if (var364 > var197)
		...
		static int method716 (int var19, int var68)
		{
			if (var19 > var68)
				return var19 + var68;
			else
		...
		static int method717 (int var837, int var130)
		{
			if (var837 > var130)
		...
		static int method718 (int var425, int var409)
		{
			if (var425 > var409)
		...
		static int method719 (int var519, int var667)
		{
			if (var519 > var667)
		...
		static int method720 (int var435, int var730)
		{
			if (var435 > var730)
		...
		static int method721 (int var228, int var610)
		{
			if (var228 > var610)
		...
		static int method722 (int var688, int var139)
		{
			if (var688 > var139)
		...
		static int method723 (int var787, int var185)
		{
			if (var787 > var185)
		...
		static int method724 (int var22, int var475)
		{
			if (var22 > var475)
				return var22 - var475;
			else
		...
		static int method725 (int var167, int var336)
		{
			if (var167 > var336)
		...
		static int method726 (int var612, int var959)
		{
			if (var612 > var959)
		...
		static int method727 (int var861, int var454)
		{
			if (var861 > var454)
		...
		static int method728 (int var41, int var951)
		{
			if (var41 > var951)
				return var41 - var951;
			else
		...
		static int method729 (int var410, int var293)
		{
			if (var410 > var293)
		...
		static int method730 (int var46, int var377)
		{
			if (var46 > var377)
				return var46 + var377;
			else
		...
		static int method731 (int var962, int var679)
		{
			if (var962 > var679)
		...
		static int method732 (int var797, int var278)
		{
			if (var797 > var278)
		...
		static int method733 (int var806, int var911)
		{
			if (var806 > var911)
		...
		static int method734 (int var689, int var179)
		{
			if (var689 > var179)
		...
		static int method735 (int var200, int var45)
		{
			if (var200 > var45)
				return var200 - var45;
			else
		...
		static int method736 (int var93, int var468)
		{
			if (var93 > var468)
				return var93 * var468;
			else
		...
		static int method737 (int var223, int var96)
		{
			if (var223 > var96)
				return var223 * var96;
			else
		...
		static int method738 (int var677, int var161)
		{
			if (var677 > var161)
		...
		static int method739 (int var529, int var169)
		{
			if (var529 > var169)
		...
		static int method740 (int var270, int var264)
		{
			if (var270 > var264)
		...
		static int method741 (int var254, int var139)
		{
			if (var254 > var139)
		...
		static int method742 (int var858, int var77)
		{
			if (var858 > var77)
				return var858 - var77;
			else
		...
		static int method743 (int var70, int var872)
		{
			if (var70 > var872)
				return var70 + var872;
			else
		...
		static int method744 (int var699, int var524)
		{
			if (var699 > var524)
		...
		static int method745 (int var149, int var551)
		{
			if (var149 > var551)
		...
		static int method746 (int var8, int var455)
		{
			if (var8 > var455)
				return var8 * var455;
			else
		...
		static int method747 (int var656, int var263)
		{
			if (var656 > var263)
		...
		static int method748 (int var321, int var881)
		{
			if (var321 > var881)
		...
		static int method749 (int var974, int var469)
		{
			if (var974 > var469)
		...
		static int method750 (int var769, int var642)
		{
			if (var769 > var642)
		...
		static int method751 (int var947, int var618)
		{
			if (var947 > var618)
		...
		static int method752 (int var153, int var854)
		{
			if (var153 > var854)
		...
		static int method753 (int var512, int var692)
		{
			if (var512 > var692)
		...
		static int method754 (int var943, int var296)
		{
			if (var943 > var296)
		...
		static int method755 (int var164, int var222)
		{
			if (var164 > var222)
		...
		static int method756 (int var308, int var701)
		{
			if (var308 > var701)
		...
		static int method757 (int var925, int var341)
		{
			if (var925 > var341)
		...
		static int method758 (int var370, int var643)
		{
			if (var370 > var643)
		...
		static int method759 (int var39, int var419)
		{
			if (var39 > var419)
				return var39 * var419;
			else
		...
		static int method760 (int var512, int var909)
		{
			if (var512 > var909)
		...
		static int method761 (int var98, int var487)
		{
			if (var98 > var487)
				return var98 * var487;
			else
		...
		static int method762 (int var572, int var671)
		{
			if (var572 > var671)
		...
		static int method763 (int var543, int var257)
		{
			if (var543 > var257)
		...
		static int method764 (int var271, int var837)
		{
			if (var271 > var837)
		...
		static int method765 (int var578, int var425)
		{
			if (var578 > var425)
		...
		static int method766 (int var342, int var667)
		{
			if (var342 > var667)
		...
		static int method767 (int var593, int var13)
		{
			if (var593 > var13)
				return var593 + var13;
			else
		...
		static int method768 (int var723, int var99)
		{
			if (var723 > var99)
				return var723 + var99;
			else
		...
		static int method769 (int var678, int var624)
		{
			if (var678 > var624)
		...
		static int method770 (int var430, int var113)
		{
			if (var430 > var113)
		...
		static int method771 (int var762, int var820)
		{
			if (var762 > var820)
		...
		static int method772 (int var300, int var934)
		{
			if (var300 > var934)
		...
		static int method773 (int var825, int var73)
		{
			if (var825 > var73)
				return var825 * var73;
			else
		...
		static int method774 (int var186, int var792)
		{
			if (var186 > var792)
		...
		static int method775 (int var808, int var699)
		{
			if (var808 > var699)
		...
		static int method776 (int var240, int var703)
		{
			if (var240 > var703)
		...
		static int method777 (int var495, int var935)
		{
			if (var495 > var935)
		...
		static int method778 (int var537, int var507)
		{
			if (var537 > var507)
		...
		static int method779 (int var599, int var930)
		{
			if (var599 > var930)
		...
		static int method780 (int var481, int var183)
		{
			if (var481 > var183)
		...
		static int method781 (int var204, int var38)
		{
			if (var204 > var38)
				return var204 * var38;
			else
		...
		static int method782 (int var859, int var965)
		{
			if (var859 > var965)
		...
		static int method783 (int var129, int var165)
		{
			if (var129 > var165)
		...
		static int method784 (int var575, int var77)
		{
			if (var575 > var77)
				return var575 + var77;
			else
		...
		static int method785 (int var220, int var673)
		{
			if (var220 > var673)
		...
		static int method786 (int var453, int var123)
		{
			if (var453 > var123)
		...
		static int method787 (int var868, int var168)
		{
			if (var868 > var168)
		...
		static int method788 (int var932, int var534)
		{
			if (var932 > var534)
		...
		static int method789 (int var570, int var199)
		{
			if (var570 > var199)
		...
		static int method790 (int var127, int var286)
		{
			if (var127 > var286)
		...
		static int method791 (int var714, int var882)
		{
			if (var714 > var882)
		...
		static int method792 (int var54, int var234)
		{
			if (var54 > var234)
				return var54 * var234;
			else
		...
		static int method793 (int var62, int var833)
		{
			if (var62 > var833)
				return var62 - var833;
			else
		...
		static int method794 (int var250, int var307)
		{
			if (var250 > var307)
		...
		static int method795 (int var467, int var914)
		{
			if (var467 > var914)
		...
		static int method796 (int var837, int var566)
		{
			if (var837 > var566)
		...
		static int method797 (int var451, int var709)
		{
			if (var451 > var709)
		...
		static int method798 (int var22, int var667)
		{
			if (var22 > var667)
				return var22 + var667;
			else
		...
		static int method799 (int var611, int var326)
		{
			if (var611 > var326)
		...
		static int method800 (int var872, int var548)
		{
			if (var872 > var548)
		...
		static int method801 (int var700, int var5)
		{
			if (var700 > var5)
				return var700 - var5;
			else
		...
		static int method802 (int var696, int var463)
		{
			if (var696 > var463)
		...
		static int method803 (int var748, int var123)
		{
			if (var748 > var123)
		...
		static int method804 (int var263, int var713)
		{
			if (var263 > var713)
		...
		static int method805 (int var271, int var622)
		{
			if (var271 > var622)
		...
		static int method806 (int var362, int var478)
		{
			if (var362 > var478)
		...
		static int method807 (int var133, int var382)
		{
			if (var133 > var382)
		...
		static int method808 (int var610, int var218)
		{
			if (var610 > var218)
		...
		static int method809 (int var165, int var341)
		{
			if (var165 > var341)
		...
		static int method810 (int var302, int var301)
		{
			if (var302 > var301)
		...
		static int method811 (int var438, int var750)
		{
			if (var438 > var750)
		...
		static int method812 (int var305, int var374)
		{
			if (var305 > var374)
		...
		static int method813 (int var192, int var219)
		{
			if (var192 > var219)
		...
		static int method814 (int var938, int var213)
		{
			if (var938 > var213)
		...
		static int method815 (int var840, int var80)
		{
			if (var840 > var80)
				return var840 - var80;
			else
		...
		static int method816 (int var161, int var95)
		{
			if (var161 > var95)
				return var161 * var95;
			else
		...
		static int method817 (int var685, int var795)
		{
			if (var685 > var795)
		...
		static int method818 (int var407, int var386)
		{
			if (var407 > var386)
		...
		static int method819 (int var429, int var724)
		{
			if (var429 > var724)
		...
		static int method820 (int var540, int var839)
		{
			if (var540 > var839)
		...
		static int method821 (int var542, int var90)
		{
			if (var542 > var90)
				return var542 - var90;
			else
		...
		static int method822 (int var57, int var299)
		{
			if (var57 > var299)
				return var57 * var299;
			else
		...
		static int method823 (int var656, int var599)
		{
			if (var656 > var599)
		...
		static int method824 (int var894, int var366)
		{
			if (var894 > var366)
		...
		static int method825 (int var321, int var361)
		{
			if (var321 > var361)
		...
		static int method826 (int var834, int var842)
		{
			if (var834 > var842)
		...
		static int method827 (int var676, int var599)
		{
			if (var676 > var599)
		...
		static int method828 (int var156, int var382)
		{
			if (var156 > var382)
		...
		static int method829 (int var424, int var998)
		{
			if (var424 > var998)
				return var424 * var998;
			else
		...
		static int method830 (int var201, int var937)
		{
			if (var201 > var937)
		...
		static int method831 (int var473, int var651)
		{
			if (var473 > var651)
		...
		static int method832 (int var552, int var454)
		{
			if (var552 > var454)
		...
		static int method833 (int var47, int var905)
		{
			if (var47 > var905)
				return var47 + var905;
			else
		...
		static int method834 (int var682, int var923)
		{
			if (var682 > var923)
		...
		static int method835 (int var665, int var662)
		{
			if (var665 > var662)
		...
		static int method836 (int var97, int var169)
		{
			if (var97 > var169)
				return var97 + var169;
			else
		...
		static int method837 (int var125, int var75)
		{
			if (var125 > var75)
				return var125 + var75;
			else
		...
		static int method838 (int var814, int var720)
		{
			if (var814 > var720)
		...
		static int method839 (int var313, int var418)
		{
			if (var313 > var418)
		...
		static int method840 (int var159, int var396)
		{
			if (var159 > var396)
		...
		static int method841 (int var933, int var291)
		{
			if (var933 > var291)
		...
		static int method842 (int var284, int var12)
		{
			if (var284 > var12)
				return var284 * var12;
			else
		...
		static int method843 (int var872, int var155)
		{
			if (var872 > var155)
		...
		static int method844 (int var123, int var380)
		{
			if (var123 > var380)
		...
		static int method845 (int var338, int var691)
		{
			if (var338 > var691)
		...
		static int method846 (int var294, int var930)
		{
			if (var294 > var930)
		...
		static int method847 (int var971, int var501)
		{
			if (var971 > var501)
		...
		static int method848 (int var638, int var649)
		{
			if (var638 > var649)
		...
		static int method849 (int var789, int var266)
		{
			if (var789 > var266)
		...
		static int method850 (int var46, int var407)
		{
			if (var46 > var407)
				return var46 * var407;
			else
		...
		static int method851 (int var737, int var65)
		{
			if (var737 > var65)
				return var737 + var65;
			else
		...
		static int method852 (int var425, int var533)
		{
			if (var425 > var533)
		...
		static int method853 (int var446, int var262)
		{
			if (var446 > var262)
		...
		static int method854 (int var757, int var36)
		{
			if (var757 > var36)
				return var757 - var36;
			else
		...
		static int method855 (int var502, int var597)
		{
			if (var502 > var597)
		...
		static int method856 (int var966, int var754)
		{
			if (var966 > var754)
		...
		static int method857 (int var418, int var470)
		{
			if (var418 > var470)
		...
		static int method858 (int var954, int var895)
		{
			if (var954 > var895)
		...
		static int method859 (int var244, int var822)
		{
			if (var244 > var822)
		...
		static int method860 (int var173, int var358)
		{
			if (var173 > var358)
		...
		static int method861 (int var999, int var794)
		{
			if (var999 > var794)
		...
		static int method862 (int var683, int var676)
		{
			if (var683 > var676)
		...
		static int method863 (int var847, int var757)
		{
			if (var847 > var757)
		...
		static int method864 (int var452, int var437)
		{
			if (var452 > var437)
		...
		static int method865 (int var820, int var137)
		{
			if (var820 > var137)
		...
		static int method866 (int var360, int var485)
		{
			if (var360 > var485)
		...
		static int method867 (int var263, int var392)
		{
			if (var263 > var392)
		...
		static int method868 (int var353, int var977)
		{
			if (var353 > var977)
		...
		static int method869 (int var749, int var408)
		{
			if (var749 > var408)
		...
		static int method870 (int var301, int var892)
		{
			if (var301 > var892)
		...
		static int method871 (int var649, int var59)
		{
			if (var649 > var59)
				return var649 * var59;
			else
		...
		static int method872 (int var534, int var903)
		{
			if (var534 > var903)
		...
		static int method873 (int var558, int var394)
		{
			if (var558 > var394)
		...
		static int method874 (int var5, int var331)
		{
			if (var5 > var331)
				return var5 + var331;
			else
		...
		static int method875 (int var45, int var715)
		{
			if (var45 > var715)
				return var45 + var715;
			else
		...
		static int method876 (int var374, int var779)
		{
			if (var374 > var779)
		...
		static int method877 (int var107, int var683)
		{
			if (var107 > var683)
		...
		static int method878 (int var902, int var598)
		{
			if (var902 > var598)
		...
		static int method879 (int var578, int var661)
		{
			if (var578 > var661)
		...
		static int method880 (int var480, int var708)
		{
			if (var480 > var708)
		...
		static int method881 (int var346, int var30)
		{
			if (var346 > var30)
				return var346 + var30;
			else
		...
		static int method882 (int var602, int var478)
		{
			if (var602 > var478)
		...
		static int method883 (int var300, int var917)
		{
			if (var300 > var917)
		...
		static int method884 (int var990, int var880)
		{
			if (var990 > var880)
		...
		static int method885 (int var480, int var565)
		{
			if (var480 > var565)
		...
		static int method886 (int var423, int var240)
		{
			if (var423 > var240)
		...
		static int method887 (int var47, int var647)
		{
			if (var47 > var647)
				return var47 + var647;
			else
		...
		static int method888 (int var728, int var303)
		{
			if (var728 > var303)
		...
		static int method889 (int var415, int var775)
		{
			if (var415 > var775)
		...
		static int method890 (int var789, int var449)
		{
			if (var789 > var449)
		...
		static int method891 (int var202, int var971)
		{
			if (var202 > var971)
		...
		static int method892 (int var175, int var560)
		{
			if (var175 > var560)
		...
		static int method893 (int var613, int var675)
		{
			if (var613 > var675)
		...
		static int method894 (int var979, int var321)
		{
			if (var979 > var321)
		...
		static int method895 (int var615, int var995)
		{
			if (var615 > var995)
		...
		static int method896 (int var689, int var913)
		{
			if (var689 > var913)
		...
		static int method897 (int var715, int var693)
		{
			if (var715 > var693)
		...
		static int method898 (int var705, int var309)
		{
			if (var705 > var309)
		...
		static int method899 (int var952, int var954)
		{
			if (var952 > var954)
		...
		static int method900 (int var260, int var892)
		{
			if (var260 > var892)
		...
		static int method901 (int var31, int var944)
		{
			if (var31 > var944)
				return var31 * var944;
			else
		...
		static int method902 (int var614, int var29)
		{
			if (var614 > var29)
				return var614 * var29;
			else
		...
		static int method903 (int var59, int var123)
		{
			if (var59 > var123)
				return var59 - var123;
			else
		...
		static int method904 (int var743, int var998)
		{
			if (var743 > var998)
		...
		static int method905 (int var19, int var914)
		{
			if (var19 > var914)
				return var19 + var914;
			else
		...
		static int method906 (int var299, int var876)
		{
			if (var299 > var876)
		...
		static int method907 (int var643, int var766)
		{
			if (var643 > var766)
		...
		static int method908 (int var707, int var983)
		{
			if (var707 > var983)
		...
		static int method909 (int var935, int var931)
		{
			if (var935 > var931)
		...
		static int method910 (int var169, int var265)
		{
			if (var169 > var265)
		...
		static int method911 (int var673, int var19)
		{
			if (var673 > var19)
				return var673 * var19;
			else
		...
		static int method912 (int var10, int var22)
		{
			if (var10 > var22)
				return var10 * var22;
			else
		...
		static int method913 (int var310, int var405)
		{
			if (var310 > var405)
		...
		static int method914 (int var185, int var604)
		{
			if (var185 > var604)
		...
		static int method915 (int var8, int var146)
		{
			if (var8 > var146)
				return var8 * var146;
			else
		...
		static int method916 (int var860, int var945)
		{
			if (var860 > var945)
		...
		static int method917 (int var449, int var620)
		{
			if (var449 > var620)
		...
		static int method918 (int var987, int var519)
		{
			if (var987 > var519)
		...
		static int method919 (int var603, int var440)
		{
			if (var603 > var440)
		...
		static int method920 (int var690, int var784)
		{
			if (var690 > var784)
		...
		static int method921 (int var758, int var122)
		{
			if (var758 > var122)
		...
		static int method922 (int var123, int var715)
		{
			if (var123 > var715)
		...
		static int method923 (int var481, int var770)
		{
			if (var481 > var770)
		...
		static int method924 (int var277, int var798)
		{
			if (var277 > var798)
		...
		static int method925 (int var415, int var685)
		{
			if (var415 > var685)
		...
		static int method926 (int var331, int var330)
		{
			if (var331 > var330)
		...
		static int method927 (int var647, int var683)
		{
			if (var647 > var683)
		...
		static int method928 (int var481, int var797)
		{
			if (var481 > var797)
		...
		static int method929 (int var664, int var537)
		{
			if (var664 > var537)
		...
		static int method930 (int var668, int var438)
		{
			if (var668 > var438)
		...
		static int method931 (int var204, int var6)
		{
			if (var204 > var6)
				return var204 + var6;
			else
		...
		static int method932 (int var188, int var254)
		{
			if (var188 > var254)
		...
		static int method933 (int var792, int var608)
		{
			if (var792 > var608)
		...
		static int method934 (int var303, int var126)
		{
			if (var303 > var126)
		...
		static int method935 (int var458, int var434)
		{
			if (var458 > var434)
		...
		static int method936 (int var47, int var384)
		{
			if (var47 > var384)
				return var47 * var384;
			else
		...
		static int method937 (int var566, int var171)
		{
			if (var566 > var171)
		...
		static int method938 (int var609, int var178)
		{
			if (var609 > var178)
		...
		static int method939 (int var893, int var704)
		{
			if (var893 > var704)
		...
		static int method940 (int var27, int var462)
		{
			if (var27 > var462)
				return var27 * var462;
			else
		...
		static int method941 (int var225, int var573)
		{
			if (var225 > var573)
		...
		static int method942 (int var750, int var762)
		{
			if (var750 > var762)
		...
		static int method943 (int var971, int var392)
		{
			if (var971 > var392)
		...
		static int method944 (int var828, int var431)
		{
			if (var828 > var431)
		...
		static int method945 (int var113, int var120)
		{
			if (var113 > var120)
		...
		static int method946 (int var226, int var453)
		{
			if (var226 > var453)
		...
		static int method947 (int var383, int var736)
		{
			if (var383 > var736)
		...
		static int method948 (int var376, int var761)
		{
			if (var376 > var761)
		...
		static int method949 (int var462, int var7)
		{
			if (var462 > var7)
				return var462 + var7;
			else
		...
		static int method950 (int var555, int var851)
		{
			if (var555 > var851)
		...
		static int method951 (int var58, int var87)
		{
			if (var58 > var87)
				return var58 * var87;
			else
		...
		static int method952 (int var951, int var799)
		{
			if (var951 > var799)
		...
		static int method953 (int var321, int var645)
		{
			if (var321 > var645)
		...
		static int method954 (int var86, int var351)
		{
			if (var86 > var351)
				return var86 * var351;
			else
		...
		static int method955 (int var111, int var814)
		{
			if (var111 > var814)
		...
		static int method956 (int var207, int var981)
		{
			if (var207 > var981)
		...
		static int method957 (int var334, int var534)
		{
			if (var334 > var534)
		...
		static int method958 (int var480, int var228)
		{
			if (var480 > var228)
		...
		static int method959 (int var798, int var268)
		{
			if (var798 > var268)
		...
		static int method960 (int var366, int var499)
		{
			if (var366 > var499)
		...
		static int method961 (int var625, int var835)
		{
			if (var625 > var835)
		...
		static int method962 (int var554, int var827)
		{
			if (var554 > var827)
		...
		static int method963 (int var672, int var139)
		{
			if (var672 > var139)
		...
		static int method964 (int var371, int var945)
		{
			if (var371 > var945)
		...
		static int method965 (int var288, int var800)
		{
			if (var288 > var800)
		...
		static int method966 (int var433, int var99)
		{
			if (var433 > var99)
				return var433 - var99;
			else
		...
		static int method967 (int var19, int var377)
		{
			if (var19 > var377)
				return var19 * var377;
			else
		...
		static int method968 (int var797, int var369)
		{
			if (var797 > var369)
		...
		static int method969 (int var141, int var372)
		{
			if (var141 > var372)
		...
		static int method970 (int var610, int var345)
		{
			if (var610 > var345)
		...
		static int method971 (int var246, int var817)
		{
			if (var246 > var817)
		...
		static int method972 (int var794, int var54)
		{
			if (var794 > var54)
				return var794 - var54;
			else
		...
		static int method973 (int var248, int var738)
		{
			if (var248 > var738)
		...
		static int method974 (int var702, int var219)
		{
			if (var702 > var219)
		...
		static int method975 (int var693, int var231)
		{
			if (var693 > var231)
		...
		static int method976 (int var216, int var359)
		{
			if (var216 > var359)
		...
		static int method977 (int var893, int var926)
		{
			if (var893 > var926)
		...
		static int method978 (int var150, int var603)
		{
			if (var150 > var603)
		...
		static int method979 (int var552, int var429)
		{
			if (var552 > var429)
		...
		static int method980 (int var396, int var297)
		{
			if (var396 > var297)
		...
		static int method981 (int var683, int var74)
		{
			if (var683 > var74)
				return var683 + var74;
			else
		...
		static int method982 (int var153, int var166)
		{
			if (var153 > var166)
		...
		static int method983 (int var479, int var718)
		{
			if (var479 > var718)
		...
		static int method984 (int var194, int var897)
		{
			if (var194 > var897)
		...
		static int method985 (int var265, int var949)
		{
			if (var265 > var949)
		...
		static int method986 (int var657, int var191)
		{
			if (var657 > var191)
		...
		static int method987 (int var54, int var936)
		{
			if (var54 > var936)
				return var54 - var936;
			else
		...
		static int method988 (int var66, int var460)
		{
			if (var66 > var460)
				return var66 + var460;
			else
		...
		static int method989 (int var752, int var622)
		{
			if (var752 > var622)
		...
		static int method990 (int var164, int var904)
		{
			if (var164 > var904)
		...
		static int method991 (int var661, int var681)
		{
			if (var661 > var681)
		...
		static int method992 (int var945, int var370)
		{
			if (var945 > var370)
		...
		static int method993 (int var374, int var687)
		{
			if (var374 > var687)
		...
		static int method994 (int var230, int var82)
		{
			if (var230 > var82)
				return var230 - var82;
			else
		...
		static int method995 (int var321, int var134)
		{
			if (var321 > var134)
		...
		static int method996 (int var1, int var100)
		{
			if (var1 > var100)
				return var1 * var100;
			else
		...
		static int method997 (int var57, int var885)
		{
			if (var57 > var885)
				return var57 + var885;
			else
		...
		static int method998 (int var952, int var349)
		{
			if (var952 > var349)
		...
		static int method999 (int var574, int var533)
		{
			if (var574 > var533)
