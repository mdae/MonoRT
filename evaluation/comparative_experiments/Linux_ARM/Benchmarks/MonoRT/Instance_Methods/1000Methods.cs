...
namespace TimingTest
{
	class Timing1000Methods
	{
		...
		static int Main (string[] args)
		{
			...
			//Console.WriteLine("PID " + currentProcess.Id.ToString());
			#endregion
			/*
			Timing1000Methods t1000mp = new Timing1000Methods();
			...
			*/
			...
			Timing1000Methods t1000m = new Timing1000Methods();
			...
			for (cnt = 0; cnt < 5; cnt++)
			{
 				sum += cleancache ();
				tsc_before = getticks ();
				//Console.WriteLine("tsc_before: " + tsc_before);
				...
				tsc_after = getticks ();
				//Console.WriteLine("tsc_after: " + tsc_after);
			...
			for (cnt = 0; cnt < 4; cnt ++)
			{
				...
				//Console.WriteLine("time1 (cycles): " + time1);
				sum++;
			}
			...
			for (cnt = 0; cnt < 6; cnt++)
			{
				...
				if (cnt == 3)
				{
					...
					//Console.WriteLine("time2 (cycles): " + time2);
				}
				if (cnt == 4)
				{
					time3 = tsc_after - tsc_before - min;
					//Console.WriteLine("time3 (cycles): " + time3);
				}
				if (cnt == 5)
				{
					time4 = tsc_after - tsc_before - min;
					//Console.WriteLine("time4 (cycles): " + time4);
				}
