...
gpointer mono_resolve_patch_target (MonoMethod *method, MonoDomain *domain, guint8 *code, MonoJumpInfo *patch_info, gboolean run_cctors, int prePatchAtRuntime) MONO_INTERNAL;
//
...
gpointer mono_jit_compile_method (MonoMethod *method, int prePatchAtRuntime) MONO_INTERNAL;
//
//  Ende Pre-JIT/-Patch Code
//
...
MonoCompile *mini_method_compile (MonoMethod *method, guint32 opts, MonoDomain *domain, gboolean run_cctors, gboolean compile_aot, int parts, int prePatchAtRuntime) MONO_INTERNAL;
//
//  Ende Pre-JIT/-Patch Code
//
...
void mono_codegen (MonoCompile *cfg, int prePatchAtRuntime) MONO_INTERNAL;
//
//  Beginn Pre-JIT/-Patch Code
//
...
void mono_arch_patch_code (MonoMethod *method, MonoDomain *domain, guint8 *code, MonoJumpInfo *ji, gboolean run_cctors, int prePatchAtRuntime) MONO_INTERNAL;
//
//  Beginn Pre-JIT/-Patch Code
//
...
//  Beginn Pre-JIT/-Patch Code
//
gconstpointer mono_icall_get_wrapper_full (MonoJitICallInfo* , gboolean);
//
//  Ende Pre-JIT/-Patch Code
//
/*
