...
//RTGC CODE
#ifdef HAVE_RT_GC
void rtgcStoreStaticValue (MonoDomain *domain, MonoClassField *field) MONO_INTERNAL;
void rtgcStoreValue (gpointer object_ptr, MonoClassField *field) MONO_INTERNAL;
#endif
int mono_rtgc_dbg;
