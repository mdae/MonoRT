...
mono_test_return_string (ReturnStringDelegate func)
{
	...
	//
	printf("\n\n\t ***C: mono_test_return_string () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_return_string () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_ref_vtype (int a, simplestruct *ss, int b, RefVTypeDelegate func)
{
	...
	if (a == 1 && b == 2 && ss->a == 0 && ss->b == 1 && ss->c == 0 &&
		...
		//  Beginn Aenderung Test
		//
		printf("\n\n\t ***C: mono_test_ref_vtype () ruft Delegate ***\n\n");
		fflush(NULL);
		//
		//  Ende Aenderung Test
		//
...
mono_test_marshal_out_struct (int a, simplestruct *ss, int b, OutVTypeDelegate func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_out_struct () VOR Aufruf Delegate***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_out_struct () NACH Aufruf Delegate***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_delegate2 (SimpleDelegate2 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: Betrete mono_test_marshal_delegate2 () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate2 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate2 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_delegate4 (SimpleDelegate4 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: Betrete mono_test_marshal_delegate4 () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate4 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate4 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_delegate5 (SimpleDelegate5 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: Betrete mono_test_marshal_delegate5 () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate5 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate5 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_delegate6 (SimpleDelegate5 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate6 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate6 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_delegate7 (SimpleDelegate7 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: Betrete mono_test_marshal_delegate7 () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate7 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate7 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_inout_byval_class_delegate (InOutByvalClassDelegate delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: momono_test_marshal_inout_byval_class_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_inout_byval_class_delegate () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_delegate8 (SimpleDelegate8 delegate, gunichar2 *s)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate8 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
{	//
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_delegate9 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_primitive_byref_delegate (PrimitiveByrefDelegate delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_primitive_byref_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_primitive_byref_delegate () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_return_delegate_delegate (ReturnDelegateDelegate d)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_return_delegate_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_pass_return_custom_in_delegate (PassReturnPtrDelegate del)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_pass_return_custom_in_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_pass_return_custom_in_delegate () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_pass_return_custom_null_in_delegate (PassReturnPtrDelegate del)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_pass_return_custom_null_in_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_pass_return_custom_null_in_delegate () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_custom_out_param_delegate (CustomOutParamDelegate del)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_custom_out_param_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_custom_out_param_delegate () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
{	//
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mmono_test_marshal_return_enum_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_blittable_struct_delegate (SimpleDelegate10 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_blittable_struct_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_blittable_struct_delegate () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate1 (SmallStructDelegate1 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate1 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate1 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate2 (SmallStructDelegate2 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate2 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate2 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate3 (SmallStructDelegate3 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate3 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate3 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate4 (SmallStructDelegate4 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate4 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate4 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate5 (SmallStructDelegate5 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate5 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate5 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate6 (SmallStructDelegate6 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate6 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate6 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate7 (SmallStructDelegate7 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate7 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate7 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate8 (SmallStructDelegate8 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate8 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate8 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate9 (SmallStructDelegate9 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate9 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate9 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate10 (SmallStructDelegate10 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate10 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate10 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_small_struct_delegate11 (SmallStructDelegate11 delegate)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate11 () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_small_struct_delegate11 () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_array_delegate (void *arr, int len, ArrayDelegate del)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_array_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_array_delegate_long (void *arr, gint64 len, ArrayDelegateLong del)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_array_delegate_long () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_out_array_delegate (int *arr, int len, ArrayDelegate del)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_out_array_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_out_array_delegate () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_return_unicode_string_delegate (UnicodeStringDelegate del)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_return_unicode_string_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_return_unicode_string_delegate () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
{	//
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_out_string_array_delegat () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_out_string_array_delegat () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_return_string_array_delegate (ReturnStringArrayDelegate d)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_return_string_array_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	if (arr == NULL) {
		...
		//  Beginn Aenderung Test
		//
		printf("\n\n\t ***C: mono_test_marshal_return_string_array_delegate () NACH Aufruf Delegate ***\n\n");
		fflush(NULL);
		//
		//  Ende Aenderung Test
		//
...
mono_test_marshal_byref_string_delegate (ByrefStringDelegate d)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_byref_string_delegate () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	if (res != 0) {
		...
		//  Beginn Aenderung Test
		//
		printf("\n\n\t ***C: mono_test_marshal_byref_string_delegate () NACH Aufruf Delegate (1)***\n\n");
		fflush(NULL);
		//
		//  Ende Aenderung Test
		//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_byref_string_delegate () NACH Aufruf Delegate (2)***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_sbyte_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_sbyte_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_byte_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_byte_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_short_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_short_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_ushort_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_ushort_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_int_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_int_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_uint_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_uint_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_long_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_long_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_ulong_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_ulong_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_float_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_float_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_double_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_double_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_bstr_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_bstr_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_bool_true_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_bool_true_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_in_bool_false_unmanaged(VarFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_in_bool_false_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_sbyte_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_sbyte_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_sbyte_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_byte_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_byte_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_byte_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_short_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_short_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_short_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_ushort_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_ushort_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_ushort_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_int_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_int_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_int_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_uint_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_uint_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_uint_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_long_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_long_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_long_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_ulong_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_ulong_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_ulong_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_float_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_float_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_float_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_double_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_double_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_double_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_bstr_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_bstr_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_bstr_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_marshal_variant_out_bool_true_unmanaged(VarRefFunc func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_bool_true_unmanaged () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_marshal_variant_out_bool_true_unmanaged () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
test_method_thunk (int test_id, gpointer test_method_handle, gpointer create_object_method_handle)
{
	...
	//  Ende Aenderung Test
	//
	gpointer (*mono_method_get_unmanaged_thunk)(gpointer) = lookup_mono_symbol ("mono_method_get_unmanaged_thunk");

	gpointer (*mono_string_new_wrapper)(const char *) = lookup_mono_symbol ("mono_string_new_wrapper");

	char* (*mono_string_to_utf8)(gpointer) = lookup_mono_symbol ("mono_string_to_utf8");

	gpointer (*mono_object_unbox)(gpointer) = lookup_mono_symbol ("mono_object_unbox");
			 ...
			 winx64_struct4 var4)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_structs_in1 () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
			 ...
			 winx64_struct1 var5)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_structs_in2 () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
			 ...
			 winx64_struct5 var6)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_structs_in3 () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_struct1_ret (void)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct1_ret () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_struct2_ret (void)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct2_ret () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_struct3_ret (void)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct3_ret () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_struct4_ret (void)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct4_ret () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_struct5_ret (void)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct5_ret () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_struct1_ret_5_args (char a, char b, char c, char d, char e)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct1_ret_5_args () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_struct5_ret6_args (char a, char b, char c, char d, char e)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct5_ret6_args () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_floatStruct (winx64_floatStruct a)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_floatStruct () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_doubleStruct (winx64_doubleStruct a)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_doubleStruct () ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_managed_Winx64_struct1_in(managed_struct1_delegate func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_managed_Winx64_struct1_in () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_managed_Winx64_struct5_in(managed_struct5_delegate func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_managed_Winx64_struct5_in () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_managed_Winx64_struct1_struct5_in(managed_struct1_struct5_delegate func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_managed_Winx64_struct1_struct5_in () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_struct1_ret_managed (managed_struct1_ret_delegate func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct1_ret_managed () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct1_ret_managed () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_Winx64_struct5_ret_managed (managed_struct5_ret_delegate func)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct5_ret_managed () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t\t*** C: mono_test_Winx64_struct5_ret_managed () NACH Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_managed_marshal_bool_in (int arg, unsigned int expected, unsigned int testVal, MarshalBoolInDelegate pfcn)
{
	...
	//  Beginn Aenderung Test
	//
	printf("\n\n\t ***C: mono_test_managed_marshal_bool_in () VOR Aufruf Delegate ***\n\n");
	fflush(NULL);
	//
	//  Ende Aenderung Test
	//
...
mono_test_managed_marshal_bool_out (int arg, unsigned int expected, unsigned int testVal, MarshalBoolOutDelegate pfcn)
{
	...
	case 1: {
		...
		//  Beginn Aenderung Test
		//
		printf("\n\n\t ***C: mono_test_managed_marshal_bool_out () VOR Aufruf Delegate ***\n\n");
		fflush(NULL);
		//
		//  Ende Aenderung Test
		//
		...
		//  Beginn Aenderung Test
		//
		printf("\n\n\t ***C: mono_test_managed_marshal_bool_out () NACH Aufruf Delegate ***\n\n");
		fflush(NULL);
		//
		//  Ende Aenderung Test
		//
				    ...
				    unsigned int outTestVal, MarshalBoolRefDelegate pfcn)
{
	...
	case 1:
	{
		...
		//  Beginn Aenderung Test
		//
		printf("\n\n\t ***C:mono_test_managed_marshal_bool_ref () VOR Aufruf Delegate ***\n\n");
		fflush(NULL);
		//
		//  Ende Aenderung Test
		//
		...
		//  Beginn Aenderung Test
		//
		printf("\n\n\t ***C:mono_test_managed_marshal_bool_ref () NACH Aufruf Delegate ***\n\n");
		fflush(NULL);
		//
		//  Ende Aenderung Test
		//
