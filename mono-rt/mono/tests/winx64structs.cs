...
class winx64structs
{
	...
	static int Main (string[] args)
	{
		...
		int ret = test_0_Ret_In_Address_managed ();
	...
	public static int test_0_In_Args_Value_In_RCX_Managed ()
	{
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: managed_struct1_delegate s1Del = new managed_struct1_delegate (managed_struct1_test) done ****\n");
		//
		//  Ende Aenderung Test
		//
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: mono_test_managed_Winx64_struct1_in (s1Del) done ****\n");
		//
		//  Ende Aenderung Test
		//
		return 0;
	...
	public static int test_0_In_Args_Value_On_Stack_ADDR_In_RCX_Managed ()
	{
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: managed_struct5_delegate s1Del = new managed_struct5_delegate (managed_struct5_test) done ****\n");
		//
		//  Ende Aenderung Test
		//
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: mono_test_managed_Winx64_struct5_in (s1Del) done ****\n");
		//
		//  Ende Aenderung Test
		//
		return 0;
	...
	public static int test_0_In_Args_Values_In_Registers_with_Stack_and_On_Stack_Managed ()
	{
		...
		managed_struct1_struct5_delegate s1Del = new managed_struct1_struct5_delegate (managed_struct1_struct5_test);
		//
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: managed_struct1_struct5_delegate s1Del = new managed_struct1_struct5_delegate (managed_struct1_struct5_test) done ****\n");
		//
		//  Ende Aenderung Test
		//
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: mono_test_managed_Winx64_struct1_struct5_in (s1Del) done ****\n");
		//
		//  Ende Aenderung Test
		//
		return 0;
	...
	public static int test_0_Ret_In_RAX_managed ()
	{
		...
		mono_test_Winx64_struct1_ret_delegate s1Del = new mono_test_Winx64_struct1_ret_delegate (mono_test_Winx64_struct1_ret_test);
		//
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: mono_test_Winx64_struct1_ret_delegate s1Del = new mono_test_Winx64_struct1_ret_delegate (mono_test_Winx64_struct1_ret_test) done ****\n");
		//
		//  Ende Aenderung Test
		//
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: mono_test_Winx64_struct1_ret_managed (s1Del) done ****\n");
		//
		//  Ende Aenderung Test
		//
		return 0;
	...
	public static winx64_struct1 mono_test_Winx64_struct1_ret_test ()
	{
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: winx64_struct1 mono_test_Winx64_struct1_ret_test () ****\n");
		//
		//  Ende Aenderung Test
		//
	...
	public static winx64_struct5 mono_test_Winx64_struct5_ret_test ()
	{
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: winx64_struct5 mono_test_Winx64_struct5_ret_test () ****\n");
		//
		//  Ende Aenderung Test
		//
