...
public class Tests
{
	public static int Main (string[] args) {
		...
		/*
		int ret = test_0_native_to_managed_custom_parameter ();
	...
	[DllImport ("libtest")]
	[return : MarshalAs(UnmanagedType.CustomMarshaler,MarshalTypeRef = typeof(Marshal1), MarshalCookie = "5")]
	private static extern object mono_test_marshal_pass_return_custom (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal1), MarshalCookie = "5")] object number, int j);
	...
	[DllImport ("libtest")]
	private static extern int mono_test_marshal_pass_out_custom (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal1), MarshalCookie = "5"), Out] out object number, int j);
	...
	[DllImport ("libtest")]
	private static extern int mono_test_marshal_pass_inout_custom (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal1), MarshalCookie = "5"), In, Out] object number, int j);
	...
	[DllImport ("libtest")]
	private static extern int mono_test_marshal_pass_out_byval_custom (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal1), MarshalCookie = "5"), Out] object number, int j);
	...
	[DllImport ("libtest")]
	private static extern int mono_test_marshal_pass_byref_custom (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal1), MarshalCookie = "5")] ref object number, int j);
	...
	private static extern object mono_test_marshal_pass_return_custom_null (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal1), MarshalCookie = "5")] object number, int j);
	...
	[return : MarshalAs(UnmanagedType.CustomMarshaler,MarshalTypeRef = typeof (Marshal1), MarshalCookie = "5")]
	public delegate object pass_return_int_delegate ([MarshalAs (UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal1), MarshalCookie = "5")] object o);
	...
	private static object pass_return_int (object i) {
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: private static object pass_return_int (object i) ****\n");
		//
		//  Ende Aenderung Test
		//
		return (int)i;
	...
	private static object pass_return_null (object i) {
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: private static object pass_return_null (object i) ****\n");
		//
		//  Ende Aenderung Test
		//
	...
	public static int test_0_pass_return_delegate () {
		...
		pass_return_int_delegate del = new pass_return_int_delegate (pass_return_int);
		Console.WriteLine("\n\t****C#: Spass_return_int_delegate del = new pass_return_int_delegate (pass_return_int) done ****\n");
		int res = mono_test_marshal_pass_return_custom_in_delegate (del);		
		//
		//  Ende Aenderung Test
		//
	...
	[DllImport ("libtest")]
	private static extern IntPtr mono_test_marshal_pass_return_custom2 (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal3), MarshalCookie = "5")] object number, int j);
	...
	private static extern IntPtr mono_test_marshal_pass_return_custom3 (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal3), MarshalCookie = "5")] object number, int j);

	[DllImport ("libtest", EntryPoint = "mono_test_marshal_pass_return_custom2")]
	private static extern IntPtr mono_test_marshal_pass_return_custom4 (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal4), MarshalCookie = "5")] object number, int j);

	[DllImport ("libtest", EntryPoint = "mono_test_marshal_pass_return_custom2")]
	private static extern IntPtr mono_test_marshal_pass_return_custom5 (int i, [MarshalAs( UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof (Marshal5), MarshalCookie = "5")] object number, int j);
	...
	private static void custom_out_param (out object i) 
	{
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t****C#: private static void custom_out_param (out object i) (out object i) ****\n");
		//
		//  Ende Aenderung Test
		//
		i = new object();	
