...
class MyRealProxy : RealProxy, IRemotingTypeInfo
{
	...
	public bool CanCastTo (Type fromType, object o) {
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t\t**** C#: bool CanCastTo (Type fromType, object o) ****\n");
		//
		//  Ende Aenderung Test
		//
...
class MainClass
{
	static int Main (string[] args) {
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t**** C#: MyRealProxy mrp = new MyRealProxy (new MBRO ()) done ****\n");
		//
		//  Ende Aenderung Test
		//
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t**** C#: object o = mrp.GetTransparentProxy () done ****\n");
		//
		//  Ende Aenderung Test
		//
		...
		//  Beginn Aenderung Test
		//
		Console.WriteLine("\n\t**** C#: mrp.CanCastToCalled = false; done ****\n");
		//
		//  Ende Aenderung Test
		//
		I1 itf1 = (I1)o;
