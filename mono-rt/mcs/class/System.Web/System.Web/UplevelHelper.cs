...
namespace System.Web {
    ...
    sealed class UplevelHelper {
        ...
        private static bool ScanForMatch_2_2(string ua, out bool hasJavaScript, int ualength) {
            hasJavaScript = true;
            if ((ualength < 25)) {
                return false;
            }
        ...
        private static bool ScanForMatch_2_5(string ua, out bool hasJavaScript, int ualength) {
            hasJavaScript = true;
            if ((ualength < 21)) {
                return false;
            }
